...
// 				setTimeout(function () {
					...
					if ($('#mapGroup').val() == 'map') {
						if(area_idx == -1) $('#selAllArea').text('<spring:message code="ewp.main.Whole_area" />');
						else $('#selAllArea').text($('.local_name:eq(1)').text());
					}
...
// 				}, 1000);
			...
			function getGMainSiteRankingTotalDetail() {
			    $.ajax({
			        url: "/main/getGMainSiteRankingTotalDetail.json",
			        type: 'post',
			...
			function getGMainSiteRankingList(selPageNum) {
			    ...
			    $.ajax({
			        url: "/main/getGMainSiteRankingList.json",
			        type: 'post',
			        async: false, // 동기로 처리해줌
			        data: formData,
			        success: function (result) {
...
//		 				var eq1Cls = siteList[i].ioe > 0 ? ' on' : '';
						...
						if (siteList != null && siteList.length > 0) $('#siteTbody > tr:eq(0)').trigger('click');
			        }
			    });
			}
...
// 				getGMainSiteTotalDetail(formData);
			...
			function goSiteMain(siteId) {
				location.href = '/main/siteMain.do?siteId=' + siteId;
			}
			...
			function getGMainGroupList(formData) {
			    $.ajax({
			        url: "/main/getGMainGroupList.json",
			        type: 'post',
			        async: false, // 동기로 처리해줌
			        data: formData,
			        success: function (result) {
			...
			function changeRanking(tabIdx) {
				...
				else if (tabIdx == 3) txt = '<spring:message code="ewp.main.Rank_revenue" />' + " (KRW)";
							...
							<div class="col-sm-12">
								<div class="indiv gmain_alarm">
									<div class="chart_top clear">
										<h2 class="ntit"><spring:message code="ewp.main.Alarm"/>
											<a id="gmainAlarmLink" href="#;" onclick="location.href='/alarm/alarmMng.do'" style="font-size: 12px;">[이동]</a>
										</h2>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="indiv gmain_chart">
									<ul class="gtab_menu">
										<li class="active" onclick="changeRanking(0);"><a href="#;"><spring:message code="ewp.main.Usage"/></a></li>
										<li onclick="changeRanking(1);"><a href="#;"><a href="#;"><spring:message code="ewp.main.Charging_discharging"/></a></li>
										<li onclick="changeRanking(2);"><a href="#;"><spring:message code="ewp.main.Power_generation"/></a></li>
										<li onclick="changeRanking(3);"><a href="#;"><spring:message code="ewp.main.Revenue"/></a></li>
									</ul>
							...
							<div class="col-sm-12">
								...
								<div id="mapUsage" class="indiv gmain_map">
									...
									<div class="local_info allmap">
										<h2 class="local_name"><spring:message code="ewp.main.Whole_area"/></h2>
										<div class="clear">
											<ul>
											...
											<ul>
												<li><strong><spring:message code="ewp.main.The_amount_charging_discharging"/></strong>
													<span class="detailCharge">0</span> <em class="detailChargeUnit">MWh</em></li>
												<li><strong><spring:message code="ewp.main.Revenue"/></strong> <span class="detailReward">0</span> <em class="detailRewardUnit">KRW</em>
												</li>
											</ul>
										</div>
									</div>
									...
									<div class="local_info detailmap">
										...
										<div class="clear">
											...
											<ul>
												...
												<li><strong><spring:message code="ewp.main.Revenue"/></strong> <span class="detailReward">0</span> <em class="detailRewardUnit">KRW</em></li>
											</ul>
										</div>
									</div>
								</div>
									...
									<div class="group_info">
										...
										<div class="clear">
											...
											<ul>
												...
												<li><strong><spring:message code="ewp.main.Revenue"/></strong> <span class="detailReward">99,000</span> <em class="detailRewardUnit">KRW</em></li>
											</ul>
										</div>
									</div>
								</div>
										...
										<table>
										    ...
										    <thead>
										      <tr>
										        ...
										        <th><spring:message code="ewp.main.Revenue"/><br>(KRW)</th>
										      </tr>
										    </thead>
										    <tbody id="siteTbody">
...
// 					format: '{y} kWh', /* 단위 넣기 */
		...
		<script type="text/javascript">
			...
			var area_idx = -1; // 지도 array 인덱스(-1:전체)
...
// 				getGMainAreaSiteCntList();
			...
			function getGMainAreaSiteCntList(formData) {
			    $.ajax({
			        url: "/main/getGMainAreaSiteCntList.json",
			        type: 'post',
			        async: false, // 동기로 처리해줌
			        data: formData,
			        success: function (result) {
