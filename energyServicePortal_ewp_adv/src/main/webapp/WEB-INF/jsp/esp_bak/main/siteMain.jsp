...
//					async : false, // 동기로 처리해줌
			...
			function getESSChargeRealList(formData) {
			    $.ajax({
			        url: "/energy/getESSChargeRealList.json",
			        type: 'post',
			        async: false, // 동기로 처리해줌
			        data: formData,
			        success: function (result) {
						...
						if (chgChartList != null && chgChartList.length > 0) {
							for (var i = 0; i < chgChartList.length; i++) {
								...
								if (chgVal === null || chgVal === "" || chgVal === "null") reChgVal = null;
									...
									var chgMap = convertUnitFormat(chgVal, "Wh", 5);
									reChgVal = toFixedNum(chgMap.get("formatNum"), 2);
									totalDataSet = totalDataSet + reChgVal;
								}
								if (dischgVal === null || dischgVal === "" || dischgVal === "null") reDischgVal = null;
								else {
									var disChgMap = convertUnitFormat(dischgVal, "Wh", 5);
									reDischgVal = toFixedNum(disChgMap.get("formatNum"), 2);
			...
			function getESSChargeFutureList(formData) {
			    $.ajax({
			        url: "/energy/getESSChargeFutureList.json",
			        type: 'post',
			        async: false, // 동기로 처리해줌
			        data: formData,
			        success: function (result) {
							...
							for (var i = 0; i < loopCntChartList.length; i++) {
								...
								if (kepcoUsageChartList != null && kepcoUsageChartList.length > 0 && kepcoUsageChartList.length > i) { // 한전사용량
									...
									if (kepcoUsage === null || kepcoUsage === "" || kepcoUsage === "null") reKepcoUsage = null;
										...
										var kepcoMap = convertUnitFormat(kepcoUsage, "Wh", 5);
										reKepcoUsage = toFixedNum(kepcoMap.get("formatNum"), 2);
								...
								if (essUsageListChartList != null && essUsageListChartList.length > 0 && essUsageListChartList.length > i) { // ESS 사용량
									...
									if (essUsage === null || essUsage === "" || essUsage === "null") reEssUsage = null;
										...
										var essMap = convertUnitFormat(essUsage, "Wh", 5);
										reEssUsage = toFixedNum(essMap.get("formatNum"), 2);
								...
								if (pvUsageListChartList != null && pvUsageListChartList.length > 0 && pvUsageListChartList.length > i) { // PV 사용량
									...
									if (pvUsage === null || pvUsage === "" || pvUsage === "null") rePvUsage = null;
										...
										var pvMap = convertUnitFormat(pvUsage, "Wh", 5);
										rePvUsage = toFixedNum(pvMap.get("formatNum"), 2);
...
//					async : false, // 동기로 처리해줌
			        ...
			        success: function (result) {
							...
							if (loopCntList != null && loopCntList.length > 0) {
								for (var i = 0; i < loopCntList.length; i++) {
									...
									if (essRvList != null && essRvList.length > 0 && essRvList.length > i) { // ess 수익
										...
										if (essRevenue === null || essRevenue === "" || essRevenue === "null") rePvRevenue = null;
										else {
											reEssRevenue = Number(essRevenue);
											totalDataSet += reEssRevenue;
										}
						...
						var total = totalDataSet + totalDataSet2 + totalDataSet3;
						$("#totalRv").empty().append(numberComma(total) + " KRW");
							...
							<div class="col-sm-12">
								<div class="indiv alarm">
									<div class="chart_top clear">
										<h2 class="ntit fl"><spring:message code="ewp.main.Alarm" /><!-- 알람 -->
											<a href="#;" onclick="location.href='/alarm/alarmMng.do'" style="font-size: 12px;">[이동]</a>
										</h2>
										<div class="fr today_alarm">
											<div class="total">
												<spring:message code="ewp.main.Occurence_today" /><!-- 금일발생 --><span id="todayTotalAlarmCnt">0</span>
											</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="indiv smain_soc">
									<div class="chart_top clear">
										<h2 class="ntit fl">
											<spring:message code="ewp.site.SOC" /><!-- SOC (잔량) -->
											<a href="#;" onclick="location.href='/energy/essCharge.do'" style="font-size: 12px;">[이동]</a>
										</h2>
									...
									<div class="soc mt15 clear">
										...
										<div class="charge_dis fr">
											<dl>
												<dt><spring:message code="ewp.site.Today_charge" /><!-- 오늘 충전량 -->
													<span id="socTodayCrg">0<em>kWh</em></span></dt>
												<dd>
													<div class="today_charge"><span style="width:0%;"><spring:message code="ewp.site.The_amount_charge" /><!-- 충전량 --></span>
													</div>
												</dd>
											</dl>
											<dl>
												<dt>
													<spring:message code="ewp.site.Today_discharge" /><!-- 오늘 방전량 -->
													<span id="socTodayDiscrg">0<em>kWh</em></span></dt>
												<dd>
													<div class="today_discharge"><span style="width:0%;"><spring:message code="ewp.site.The_amount_discharge" /><!-- 방전량 --></span>
													</div>
												</dd>
											</dl>
										</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="indiv der">
									<div class="chart_top clear">
										<h2 class="ntit fl">
											<spring:message code="ewp.site.Usage_composition" /><!-- 사용량 구성 (DER) -->
											<a href="#;" onclick="location.href='/energy/derUsage.do'" style="font-size: 12px;">[이동]</a>
										</h2>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="indiv peak">
									<div class="chart_top clear">
										<h2 class="ntit fl">
											<spring:message code="ewp.site.Peak_demand_status" /><!-- 피크전력현황 -->
											<a href="#;" onclick="location.href='/energy/peak.do'" style="font-size: 12px;">[이동]</a>
										</h2>
									...
									<div class="chart_notice">
										<strong><spring:message code="ewp.site.Time_not_covered_rate_plan"/></strong> <!-- 요금적용전력 제외시간 --> <span>(23:00 ~ 09:00)</span>
									</div>
									<!-- no-data { -->
									<div class="no-data" style="display: none;">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="indiv smain_device">
									<div class="chart_top clear">
										<h2 class="ntit fl">
											<spring:message code="ewp.site.Device_status" /><!-- 장치현황 -->
											<a href="#;" onclick="location.href='/device/deviceGroup.do'" style="font-size: 12px;">[이동]</a>
										</h2>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="indiv income">
									<div class="chart_top clear">
										<h2 class="ntit fl">
											<spring:message code="ewp.site.Revenue_status" /><!-- 수익현황 -->(최근 7일)
											<a href="#;" onclick="location.href='/billRevenue/essRevenue.do'" style="font-size: 12px;">[이동]</a>
										</h2>
										...
										<script language="JavaScript" type="text/javascript">
											var incomeChart = Highcharts.chart('income_chart', {
												...
												tooltip: {
													formatter: function () {
														return '<b>' + this.series.name + '</b><br/>' + Highcharts.dateFormat('%Y-%m-%d %H:%M:%S ', new Date(this.x))
															+ '<br/><span style="color:#438fd7">' + this.y + ' KRW</span>';
													}
												},
									...
									<div class="chart_footer">
										<ul class="clear">
											<li><spring:message code="ewp.site.Total_revenue" /><!-- 전체수익 --> <span id="totalRv">0 KRW</span></li>
										</ul>
									</div>									
								</div>
							</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="indiv charge">
									<div class="chart_top clear">
										<h2 class="ntit fl">
											<spring:message code="ewp.main.The_amount_charging_discharging" /><!-- 충/방전량 -->
											<a href="#;" onclick="location.href='/energy/essCharge.do'" style="font-size: 12px;">[이동]</a>
										</h2>
										...
										<div class="chart_table">
											<table class="main_use">
												<thead>
													<tr>
														<th>
															<spring:message code="ewp.main.The_amount_charging_discharging" /><!-- 충/방전량 --></th>
														<th>
															<spring:message code="ewp.site.The_amount_charge" /><!-- 충전량 --></th>
														<th>
															<spring:message code="ewp.site.The_amount_discharge" /><!-- 방전량 --></th>
														<th>
															<spring:message code="ewp.main.Revenue" /><!-- 수익 --></th>
													</tr>
												</thead>
												<tbody>
													<tr>
