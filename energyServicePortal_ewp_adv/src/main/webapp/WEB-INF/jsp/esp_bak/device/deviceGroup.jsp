...
<script type="text/javascript">
	...
	function getDeviceNotInGroupList() {
		$.ajax({
			url : "/device/getDeviceNotInGroupList.json",
			type : 'post',
	...
	function getDeviceGroupList() {
	    $.ajax({
	        url: "/device/getDeviceGroupList.json",
	        type: 'post',
	        async: false, // 동기로 처리해줌
//			data : {
//				siteId : siteId
//			},
	...
	function getDvInDeviceGroupList(deviceGrpIdx) {
	    $.ajax({
	        url: "/device/getDvInDeviceGroupList.json",
	        type: 'post',
	        async: false, // 동기로 처리해줌
	        data: {
	...
	function getDeviceGrpAlarmList(deviceGrpIdx) {
		$.ajax({
			url : "/device/getDeviceGrpAlarmList.json",
			type : 'post',
			async : false, // 동기로 처리해줌
			data : {
				deviceGrpIdx : deviceGrpIdx
	...
	function getDeviceGrpSitePopupList(siteGrpIdx) {
		$.ajax({
			url : "/device/getDeviceGrpSitePopupList.json",
			type : 'post',
			async : false, // 동기로 처리해줌
			data : {
	...
	function getDvInDeviceGroupPopupList(siteId, deviceGrpIdx) {
	    $.ajax({
	        url: "/device/getDvInDeviceGroupPopupList.json",
	        type: 'post',
	        async: false, // 동기로 처리해줌
	        data: {
	            siteId: siteId,
	...
	function saveDvGrp(formData, dvGrpInsUpdFlag) {
		var url = "";
		if(dvGrpInsUpdFlag ===  1) url = "/device/insertDeviceGroup.json";
		else if(dvGrpInsUpdFlag ===  2)  url = "/device/updateDeviceGroup.json";
		$.ajax({
			url : url,
			type : 'post',
			async : false, // 동기로 처리해줌
	...
	function deleteDvGrp(dvGrpIdx) {
		if(confirm("삭제하시겠습니까?")) {
			$.ajax({
				url : "/device/deleteDeviceGroup.json",
				type : 'post',
				async : false, // 동기로 처리해줌
				data : {
