...
// 				getPVGenFutureList(formData); // 예측 발전량 조회
			...
			function getPVGenRealList(formData) {
				$.ajax({
					url: "/energy/getPVGenRealList.json",
					type: 'post',
							...
							if (sheetList != null && sheetList.length > 0) {
								...
								for (var i = 0; i < sheetList.length; i++) {
						            ...
						            if(SelTerm == "year" && periodd == "day") {
						            	tempDate = new Date(sheetList[i].std_date);
			...
			function getPVGenFutureList(formData) {
				$.ajax({
					url: "/energy/getPVGenFutureList.json",
					type: 'post',
					async: false, // 동기로 처리해줌
					data: formData,
					success: function (result) {
						...
						<div class="indiv">
							<div class="tbl_top clear">
								...
								<ul class="fr">
									...
									<li><a href="#;" class="save_btn" onclick="exportExcel('PV발전량');">데이터저장</a></li>
