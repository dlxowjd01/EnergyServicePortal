...
<script type="text/javascript">
	...
	$(document).on('click', '#myTabs .btn-close', function(e) {
		...
		confirmTitle.data('targetId', targetId);
		confirmTitle.data('targetTab', targetTab);
	...
	$('#comDeleteBtn').click(function() {
		...
		$('#confirmTitle').val('');
		const targetId = $('#confirmTitle').data('targetId'), targetTab = $('#confirmTitle').data('targetTab');
		tabClose(targetId, targetTab);
	});

	const tabClose = (targetId, targetTab) => {
								...
								<td>
									<div class="fixed-height group-type short">
										...
										--><ul class="dropdown-menu" role="menu"><!--
											...
											--><li data-value="입출금"><a href="#">입출금</a></li><!--
										--></ul><!--
								--></div>
									...
									--><ul id="계좌구분리스트[index]" class="dropdown-menu" role="menu"><!--
										--><li data-value="관리운영비"><a href="#">관리 운영비</a></li><!--
										--><li data-value="사무수탁비"><a href="#">사무 수탁비</a></li><!--
										--><li data-value="공사비"><a href="#">공사비</a></li><!--
										--><li data-value="임대료"><a href="#">임대료</a></li><!--
										--><li data-value="대납금"><a href="#">대납금</a></li><!--
										--><li data-value="부채상환"><a href="#">부채 상환</a></li><!--
										--><li data-value="대수선비"><a href="#">대수선비</a></li><!--
										--><li data-value="배당금적립"><a href="#">배당금 적립</a></li><!--
										--><li data-value="일반지출"><a href="#">일반 지출</a></li><!--
										--><li data-value="DSRA적립"><a href="#">DSRA 적립</a></li><!--
