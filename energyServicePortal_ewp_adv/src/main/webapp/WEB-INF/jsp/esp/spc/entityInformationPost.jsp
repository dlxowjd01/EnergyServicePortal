	...
	<div class="row entity_wrap post">
		<div class="col-lg-12">
				...
				<div class="spc_tbl_row st_edit">
					<table>
						...
						<tr>
							...
							<td class="group_type03">
								<div class="dropdown placeholder edit">
									<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">발전소
										<span class="caret"></span>
									</button>
									<ul class="dropdown-menu" role="menu" id="type">
										<li><a href="#;">발전소1</a></li>
						...
						<tr>
							...
							<td colspan="3" class="group_type03">
								...
								<div class="dropdown placeholder edit">
									<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">시도 선택
										<span class="caret"></span>
									</button>
									<ul class="dropdown-menu" role="menu" id="type">
				...
				<div class="spc_tbl_row st_edit">
					<table>
						...
						<tr>
							...
							<td>
								<div class="tx_inp_type edit">
									<input type="text" placeholder="부서 명">
								</div>
							</td>
							<th>담당자</th>
							<td class="group_type">
								<div class="tx_inp_type edit">
									<input type="text" placeholder="담당자 명">
								</div>
								<div class="tx_inp_type edit">
						...
						<tr>
							...
							<td>
								...
								<div class="chk_type align_type fl">
									<span>
										<input type="checkbox" id="chk_04_op01" name="chk_04_op01">
						...
						<tr>
							...
							<td>
								<div class="chk_type align_type">
									<span>
										<input type="checkbox" id="chk_op01" name="chk_op">
						...
						<tr>
							...
							<td class="group_type">
								...
								<div class="rdo_type align_type">
									<span>
										<input type="radio" id="rdo_03_op01" name="rdo_op">
						...
						<tr>
							...
							<td>
								<div class="chk_type align_type">
									...
									<span>
										<input type="checkbox" id="chk_02_op02" name="chk_op2" >
			...
			<div class="btn_wrap_type04">
				<button type="button" class="btn_type big">등록</button>
			</div>
		</div>
	</div>
  </body>
