...
function spcListChange(){
	...
	if(jsonData.spc_id == ""){
		...
		$("#countryValue").val(JSON.parse(jsonData.spc_info)["countryValue"]);
		setDropDownValue("countryList", JSON.parse(jsonData.spc_info)["countryValue"]);
		$("#sidoValue").val(JSON.parse(jsonData.spc_info)["sidoValue"]);
		setDropDownValue("sidoList", JSON.parse(jsonData.spc_info)["sidoValue"]);
		$("#상세_주소").val(JSON.parse(jsonData.spc_info)["상세_주소"])		
	}
}
