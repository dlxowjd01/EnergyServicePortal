								...
								<tr>
									...
									<td>
										<div class="sel_calendar">
											<input type="text" id="datepicker1" class="sel" value="" autocomplete="off" readonly placeholder="선택">
										</div>
									</td>
									<td>
										<div class="sel_calendar">
											<input type="text" id="datepicker2" class="sel" value="" autocomplete="off" readonly placeholder="선택">
										</div>
									</td>
									<td>자동 계산</td>
									<td>
