            ...
            <script type="text/javascript">
                    ...
                    if (data.length > 0) {
                        data.forEach(function(v, k) {
                            ...
                            calendar.eq(Number(job_date) - 1).append(
                                '<a href="javascript:maintenance(\'get\', \'' + v.id + '\');" data-jobid="' + v.id + '"><p class="bu t' + job_type + '">[' + job_info.siteName + ']' + job_Name(job_type) + '</p></a>'
                            );
                        });
                    }
                ...
                const modalPopInit = function(data) {
                    if (data == undefined) {
                        ...
                        $('#registerModal .btn_wrap_type02 .btn_type04').hide();
                                    ...
                                    <tr>
                                        ...
                                        <td class="ly_w_type">
                                            <div class="dropdown fl" id="repeat_yn">
                                                <button class="btn btn-primary dropdown-toggle required" type="button" data-toggle="dropdown" data-name="점검 선택">
										점검 선택<span class="caret"></span>
                                            ...
                                            <div class="dropdown fl" style="display:none;" id="repeat_unit">
                                                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" data-name="주기 선택">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown placeholder" id="repeat_before_after_holiday">
                                                <button class="btn btn-primary dropdown-toggle required" type="button" data-toggle="dropdown" data-name="공휴일 처리 선택">
										<span class="caret"></span>
									</button>
                                                <ul class="dropdown-menu">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="txarea_inp_type">
                                                <textarea id="description" name="description" placeholder="입력" rows="5"></textarea>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown fl" id="alarmSetup" style="width:160px">
                                                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" data-name="알림 일시 선택">
                                        ...
                                        <td>
                                            <div class="clear">
                                                <div class="dropdown placeholder fl" style="width:160px" id="alarmTime">
                                                    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" data-name="알림 시간 선택">
											<span class="caret"></span>
										</button>
                                                    <ul class="dropdown-menu">
                    ...
                    <div class="indiv pd_type">
                        <div class="schedule_area">
                            <div class="sch_top_info clear">
                                ...
                                <a href="#" class="btn_type fr" id="register">등록</a>
