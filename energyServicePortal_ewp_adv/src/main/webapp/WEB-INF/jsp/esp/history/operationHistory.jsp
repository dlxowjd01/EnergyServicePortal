                        ...
                        <div class="facility-type-wrap">
                            ...
                            <div class="sa_select">
                                <div class="dropdown" id="deviceType">
                                    <button class="btn btn-primary dropdown-toggle w2" type="button" data-toggle="dropdown" data-name="설비유형">
                            ...
                            <div class="fl" id="analyzeDiv1">
                                <div class="sa_select">
                                    <div class="dropdown" id="chartDid">
                                        <button class="btn btn-primary dropdown-toggle w2" type="button" data-toggle="dropdown" style="width:220px;" data-name="설비명">
                                ...
                                <div class="sa_select">
                                    <div class="dropdown">
                                        <button class="btn btn-primary dropdown-toggle w2" type="button" data-toggle="dropdown" data-name="선택">
                                ...
                                <div class="fl">
                                    ...
                                    <div class="sa_select">
                                        <div class="dropdown" id="chartDid2">
                                            <button class="btn btn-primary dropdown-toggle w2" type="button" data-toggle="dropdown" style="width:220px;" data-name="설비명">설비명<span class="caret"></span></button>
