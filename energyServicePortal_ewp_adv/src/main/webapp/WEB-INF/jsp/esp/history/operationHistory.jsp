...
<script type="text/javascript">
			...
			success: function (result) {
				...
				$.map(result, function (value, key) {
					if ($('#' + key + '_Table').length > 0) {
						...
						setMakeList(value, key + '_Table', {'dataFunction': {'operation': oprationSet}}); //list생성
	...
	const oprationSet = function (operation) {
		let txt = '-';
		if (operation != '') {
			if (operation == 0) {
				txt = 'stop';
	...
	<div class="col-12">
		<div class="inline-wrapper">
			<div class="search-select dropdown" id="siteList">
				<button type="button" class="btn btn-primary dropdown-toggle w1" data-toggle="dropdown" data-name="사업소">
					...
					<div class="fl" id="analyzeDiv1">
						<div class="sa_select">
							<div class="dropdown" id="chartDid">
								<button class="btn btn-primary dropdown-toggle w2" type="button" data-toggle="dropdown"
								        style="width:220px;" data-name="설비명">
							...
							<div class="sa_select">
								<div class="dropdown" id="chartDid2">
									<button class="btn btn-primary dropdown-toggle w2" type="button"
									        data-toggle="dropdown" style="width:220px;" data-name="설비명">설비명<span
