							...
							<table class="his_tbl">
								<thead>
									<tr>
										...
										<th><input type="checkbox" name="" id="hchk5" class="his_chk" checked><label for="hchk5">금일발전량</label></th>
										<th><input type="checkbox" name="" id="hchk6" class="his_chk" checked><label for="hchk6">누적발전량</label></th>
