		...
		<div class="indiv">
			...
			<div class="chart_legend_area">
				...
				<ul class="chart_legend col">
					<li><div><p class="bu t1">PCS</p><span class="value">8건</span></div></li>
					<li><div><p class="bu t2">접속반</p><span class="value">8건</span></div></li>
					<li><div><p class="bu t3">BMS</p><span class="value">8건</span></div></li>
					<li><div><p class="bu t4">환경센서</p><span class="value">8건</span></div></li>
					<li><div><p class="bu t5">태양광 인버터</p><span class="value">8건</span></div></li>
					<li><div><p class="bu t6">계량기</p><span class="value">8건</span></div></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="indiv">
			<div class="tbl_wrap_type">
				...
				<table class="his_tbl">
					<thead>
						<tr>
							<th><button class="btn_align up">장비 타입</button></th>
							<th><button class="btn_align up">장치명</button></th>
							<th><button class="btn_align up">장치 ID</button></th>
							<th><button class="btn_align up">알람 시간</button></th>
							<th><button class="btn_align up">알람 타입</button></th>
							<th><button class="btn_align down">알림 메시지</button></th>
							<th><button class="btn_align down">알림 상태</button></th>
