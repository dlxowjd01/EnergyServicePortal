...
<div id="layerbox" class="ddevice">
    <div class="device_modal_content">
        <div class="modal-header stit">
            <h2>신규 장치 등록</h2>
        </div>
        <form id="deviceForm" action="#" method="post" name="deviceForm" novalidate>
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="input-group inline-flex">
                        <label for="site_name">사업소</label>
                    ...
                    <div class="input-group inline-flex">
                        <label for="site_name mr-10">장치명</label>
                        <input class="input tx_inp_type"  type="text" name="" id="site_name">
                    </div>
                    <div class="input-group inline-flex">
                        <label for="site_name mr-10">장치 타입</label>
                        <div id="siteName" class="dropdown">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                                선택해주세요.<span class="caret"></span>
                            </button>
                    ...
                    <div class="input-group inline-flex">
                        <label for="site_name mr-10">계량 유형</label>
                        <div id="siteName" class="dropdown">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                                선택해주세요.<span class="caret"></span>
                            </button>
                    ...
                    <div class="input-group inline-flex">
                        <label for="site_name mr-10">설비 용량(kW)</label>
                        <input class="input tx_inp_type"  type="text" name="" id="site_name">
                    </div>
                    <div class="input-group inline-flex">
                        <label for="site_name mr-10">제조사</label>
                        <input class="input tx_inp_type"  type="text" name="" id="site_name">
                    </div>
                    <div class="input-group inline-flex">
                        <label for="site_name mr-10">담당자</label>
                        <input class="input tx_inp_type"  type="text" name="" id="site_name">
                    </div>
                    <div class="input-group inline-flex">
                        <label for="site_name mr-10">알림 코드</label>
                        <div id="siteName" class="dropdown">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                                선택해주세요.<span class="caret"></span>
                            </button>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="input-group inline-flex">
                        <label for="site_name mr-10">예측</label>
                        <input type="checkbox" class="checkbox" id="site_name">
                    </div>
                    <div class="input-group inline-flex">
                        <label for="site_name">장치 ID</label>
                        <div id="siteName" class="dropdown">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                                선택해주세요.<span class="caret"></span>
                            </button>
                    ...
                    <div class="input-group inline-flex">
                        <label for="site_name">상위 장치</label>
                        <div id="siteName" class="dropdown">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                                선택해주세요.<span class="caret"></span>
                            </button>
                    ...
                    <div class="input-group inline-flex">
                        <label for="site_name">표시 유형</label>
                        <input class="input tx_inp_type"  type="text" name="" id="site_name">
                    </div>
                    <div class="input-group inline-flex">
                        <label for="site_name">제품명</label>
                        <input class="input tx_inp_type"  type="text" name="" id="site_name">
                    </div>
                    <div class="input-group inline-flex">
                        <label for="site_name">담당자 연락처</label>
                        <input class="input tx_inp_type"  type="text" name="" id="site_name">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="input-group inline-flex">
                        <label for="site_name mr-10">설명</label>
                        <textarea name="desc" class="textarea" id="site_name"></textarea>
                    </div>
                </div>
            </div>
        </form>
        <div class="btn_center">
            <button type="button" class="btn_type03" id="cancelBtn">취소</a>
            <button type="button" class="btn_type" id="confirmBtn">등록</button>
        </div>
    </div>
</div>
