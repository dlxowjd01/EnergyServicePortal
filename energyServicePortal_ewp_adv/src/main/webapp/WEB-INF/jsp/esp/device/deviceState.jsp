  ...
  function getSiteMainSchCollection(termType) { //api에 맞게 수정필요
						...
						<div class="row">
							<div class="col-lg-8">
								<div class="indiv clear">
									...
									<ul class="eq_list scroll eq_li_type01" id = "device_list1">
									</ul>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="indiv eq_card">
										...
										<ul class="isb_in clear">
											...
											<li>
												<ul class="di_list">
													...
													<li>
														<span class="di_li_tit">온도</span>
														<span class="di_li_tx">39.5℃</span>
													</li>
												</ul>
											</li>
										</ul>
									...
									<div class="eq_btn_bx">
										<button type="button" class="btn_type04">변경 이력 조회</button>
										<button type="button" class="btn_type04">운영 이력 조회</button>
									</div>
								</div>
							</div>
						</div>
    ...
    <div id="layerbox" class="ddevice" style="min-width:600px;">
		...
		<div class="lbody mt30">
			...
			<div class="set_tbl" style="overflow-x:inherit;">
				<table>
					<colgroup>
						<col width="150">
						<col>
					...
					<tbody>
						<tr>
							...
							<td style="padding-right:20px;">
								<select name="" id="addDeviceSite" class="sel" style="width:100%">
<!-- 									<option value="" selected>사업소#1</option> -->
<!-- 									<option value="">사업소#2</option> -->
<!-- 									<option value="">사업소#3</option> -->
<!-- 									<option value="">사업소#4</option> -->
								</select>
							</td>
							<th><span>예측</span></th>
						...
						<tr>
							<th><span>장치명</span></th>
							<td style="padding-right:20px;"><input type="text" id="addDeviceName" class="input" style="width:100%"></td>
						...
						<tr>
							...
							<td style="padding-right:20px;">
								<select name="" id="addDeviceType" class="sel" style="width:100%">
									<option value="SM" selected>스마트미터</option>
									<option value="SM_ISMART">한전아이스마트</option>
									<option value="SM_KPX">전력거래소 계량포털</option>
									<option value="SM_CRAWLING">데이터 수집기</option>
									<option value="SM_MANUAL">수기입력</option>
									<option value="INV_PV">태양광 인버터</option>
									<option value="INV_WIND">풍력 인버터</option>
									<option value="PCS_ESS">ESS PCS</option>
									<option value="BMS_SYS">BMS 시스템</option>
									<option value="BMS_RACK">BMS 랙</option>
									<option value="SENSOR_SOLAR">태양광 센서</option>
									<option value="SENSOR_FLAME">불꽃 감지 센서</option>
									<option value="SENSOR_TEMP_HUMIDITY">온습도 센서</option>
									<option value="CCTV">CCTV</option>
									<option value="COMBINER_BOX">태양광 접속반</option>
									<option value="CIRCUIT_BREAKER">회로 차단기</option>
								</select>
							</td>
							<th><span>상위장치</span></th>
							<td>
						...
						<tr id="type_ess" style="display:none;">
							<th><span>데이터 수집 방법</span></th>
							<td colspan="3">
								<select name="" id="" class="sel" style="width:100%">
									<option value="">로컬 EMS</option>
									<option value="">RTU</option>
								</select>
							</td>
						</tr>
						<tr id="type_ess_sub1" style="display:none;">
							<th><span>접속 URL</span></th>
							<td colspan="3"><input type="text" class="input" style="width:100%"></td>
						</tr>
						<tr id="type_ess_sub1" style="display:none;">
							<th><span>접속 암호키</span></th>
							<td colspan="3"><input type="text" class="input" style="width:100%"></td>
						</tr>
						<tr id="type_ess_sub2" style="display:none;">
							<th><span>브로커 URL</span></th>
							<td colspan="3"><input type="text" class="input" style="width:100%"></td>
						</tr>
						<tr id="type_ess_sub2" style="display:none;">
							<th><span>토픽</span></th>
						...
						<tr>
							<th><span>계량유형</span></th>
							<td style="padding-right:20px;">
								<select name="" id="" class="sel" style="width:100%">
									<option value="" selected>발전계량</option>
									<option value="">소모계량</option>
									<option value="">충/방전계량</option>
								</select>
							</td>
							<th><span>표시유형</span></th>
							<td>
								<select name="" id="addDeviceDisplayType" class="sel" style="width:100%">									
									<option value="0">없음</option>
									<option value="1" selected>대시보드</option>
									<option value="2">매전정보</option>
								</select>
							</td>
						</tr>
						<tr>
							<th><span>설비용량</span></th>
							<td style="padding-right:20px;"><input type="text" id="addDeviceCapacity" class="input" style="width:calc(100% - 30px);"> kw</td>
							<th><span>제품명</span></th>
							<td><input type="text" id="addDeviceProductName" class="input" style="width:100%"></td>
						</tr>
						<tr>
							<th><span>제조사</span></th>
							<td style="padding-right:20px;"><input type="text" id="addDeviceManufacturer" class="input" style="width:100%"></td>
							<th><span>시리얼ID</span></th>
							<td><input type="text" id="addDeviceSerialID" class="input" style="width:100%"></td>
						</tr>
						<tr>
							<th><span>담당자</span></th>
							<td style="padding-right:20px;"><input type="text" id="addDeviceManager" class="input" style="width:100%"></td>
							<th><span>담당자 연락처</span></th>
							<td><input type="text" id="addDeviceContact" class="input" style="width:100%"></td>
						</tr>
						<tr>
							<th><span>알람코드</span></th>
							<td colspan="3">
								<div class="select" style="width:100%">
									<a href="#;">장치 알람 메시지 설정</a>
									<ul class="inq">
										<li>
											<input type="checkbox" name="" id="cchk1" class="his_chk">
											<label for="cchk1">공통코드 관리에서 사전 정의된 알람 메시지 타입 #1</label>
										</li>
										<li>
											<input type="checkbox" name="" id="cchk2" class="his_chk">
											<label for="cchk2">공통코드 관리에서 사전 정의된 알람 메시지 타입 #2</label>
										</li>
										<li>
											<input type="checkbox" name="" id="cchk3" class="his_chk">
											<label for="cchk3">공통코드 관리에서 사전 정의된 알람 메시지 타입 #3</label>
										</li>
										<li>
											<input type="checkbox" name="" id="cchk4" class="his_chk">
											<label for="cchk4">공통코드 관리에서 사전 정의된 알람 메시지 타입 #4</label>
										</li>
										<div class="mt20 right" style="padding-right:10px">
											<button type="button" class="dbtn">저장</button>
										</div>
									</ul>
								</div>
							</td>
						...
						<tr>
							<th><span>설명</span></th>
							<td colspan="3">
								<textarea name="" id="addDeviceDescription" cols="30" rows="10" class="textarea" style="width:100%"></textarea>
							</td>
						</tr>
					</tbody>			
				</table>
...
<!-- 			<a href="#;" class="default_btn w80">확인</a> -->
			<button type="submit" class="addDeviceBtn default_btn w80">확인</button>
<!-- 			<a href="javascript:addDevice('device1000', 1500);" class="default_btn w80">확인</a> -->
