...
// 		}],
	...
	function getSitePopupList() {
		...
		var map1 = new _Map();
		var map2 = new _Map();
		map1.put("site_name", "혜원 솔라 1호기");
		map1.put("site_addr", "강원도 고성군 간성읍 해상리 산 137-2");
		map1.put("site_id", "1");
		list.push(map1);
		map2.put("site_name", "혜원 솔라 2호기");
		map2.put("site_addr", "강원도 고성군 간성읍 해상리 산 137-2");
		map2.put("site_id", "2");
		list.push(map2);
	...
	<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
		...
		<div class="indiv gmain_table">
			<div class="gtbl_top clear">
				<div class="fl">
					<input type="text" class="input" value="" placeholder="사업소 검색">
						...
						<tr class="detail_info list1 flag1">
							<td colspan="9">
								<div class="di_wrap">
									...
									<%--					<div id="type_chart1" class="inchart" style="height:100%;text-align:center"></div>--%>
									<%--          <script language="JavaScript">--%>
									<%--            $(function () {--%>
									...
									<div class="di_wrap_in">
										...
										<div class="di_btm_sec clear">
											<div class="sec_bx left">
												<div class="bx_in">
													<div class="bx_top">
														<!-- [D] 차트 개발 시 style 삭제해주세요. -->
														<div class="inchart" id="type_chart1"
																style="height:100%;text-align:center">차트영역
														</div>
														<script type="text/javascript">
															$(function () {
										...
										<div class="btn_bx clear"><a
												href="/dashboard/smain.do?sid=0c7c90c6-9505-4f77-b42d-500c2879c689"
												class="btn_type02 fr">대시 보드 보기<span
												class="ico_arrow"></span></a></div>
									</div>
								</div>
							</td>
						</tr>
			...
			<span class="ico wind"></span> -->
										...
										<div class="di_btm_sec clear">
											<div class="sec_bx left">
												<div class="bx_in">
													<div class="bx_top">
														<!-- [D] 차트 개발 시 style 삭제해주세요. -->
														<div class="inchart" id="type_chart2"
																style="height:100%;text-align:center">차트영역
														</div>
														<script language="JavaScript">
															$(function () {
										...
										<div class="btn_bx clear">
											<a href="/dashboard/smain.do?sid=fa313b15-1fe1-41e3-b592-5a739e3d9b37" class="btn_type02 fr">
												대시 보드 보기
			...
			success: function (result) {
				...
				result.forEach((site, siteIdx) => {
					$.ajax({
						...
						success: function (result) {//api 요청결과
							let generationSum = 0;
							result.data[0].generation.items.forEach((e) => {
