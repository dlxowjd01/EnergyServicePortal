		...
		<div class="fl">
			...
			<div class="sa_select">
				<div class="dropdown" id="reportClass">
					<button class="btn btn-primary dropdown-toggle w7" type="button" data-toggle="dropdown"><fmt:message key="revenuereport.1.all" /><span class="caret"></span></button>
		...
		<div class="fl">
			...
			<div class="sa_select">
				<div class="dropdown" id="year">
					<button class="btn btn-primary dropdown-toggle w7" type="button" data-toggle="dropdown"><fmt:message key="revenuereport.1.2020" /><span class="caret"></span></button>
					<ul class="dropdown-menu" role="menu">
			...
			<div class="sa_select">
				<div class="dropdown" id="month">
					<button class="btn btn-primary dropdown-toggle w3" type="button" data-toggle="dropdown"><fmt:message key="revenuereport.1.all" /><span class="caret"></span></button>
					<ul class="dropdown-menu" role="menu">
						<li><a href="javascript:void(0);"><fmt:message key="revenuereport.1.all" /></a></li>
				...
				<table class="sort_table chk_type" id="yield_table">
					<thead>
						<tr>
							...
							<th><button class="btn_align down"><fmt:message key="revenuereport.2.plant" /></button></th>
							<th><button class="btn_align down"><fmt:message key="revenuereport.2.report_classification" /></button></th>
							...
							<th><button class="btn_align down"><fmt:message key="revenuereport.2.report_confirmation" /></button></th>
