										...
										<c:when test="${schGbn eq 'alarm' }"><!-- 상황관제 -->
											<h2 class="ntit fl">알림현황</h2>
												<div class="dropdown fl">
												  <button class="dropdown-toggle" type="button" data-toggle="dropdown" id="selTermBox">1일
											...
											<div class="term fl clear">
												<c:choose>
													<c:when test="${schGbn eq 'energy_drResult' }"> <!-- DR 실적 조회 -->
														<div class="dropdown fl">
														  <button class="dropdown-toggle" type="button" data-toggle="dropdown" id="selTermBox">1일(오늘)
														  <span class="caret"></span></button>
														  <ul class="dropdown-menu">
														...
														<div class="dropdown fl">
														  <button class="dropdown-toggle" type="button" data-toggle="dropdown" id="selPeriod">15분
														  <span class="caret"></span></button>
														  <ul class="dropdown-menu">
													...
													<c:if test="${schGbn eq 'energy' }">
														...
														<div class="dropdown fl">
														  <button class="dropdown-toggle" type="button" data-toggle="dropdown" id="selPeriod">1시간
														  <span class="caret"></span></button>
														  <ul class="dropdown-menu">
														    <li class="on" id="sp_15min"><a href="#" onclick="changePeriod('15min');">15분</a></li>
