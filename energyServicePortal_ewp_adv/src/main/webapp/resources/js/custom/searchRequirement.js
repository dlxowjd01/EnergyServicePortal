...
//		startTime = new Date(firstDay.setMinutes(firstDay.getMinutes() - 15));
		var tempMin = (firstDay.getMinutes() < 15)? 0: (firstDay.getMinutes() < 30)? 15: (firstDay.getMinutes() < 45)? 30:45;
		startTime = new Date(firstDay.getFullYear(), firstDay.getMonth(), firstDay.getDate(), firstDay.getHours(), tempMin, 0);
		endTime = new Date(endDay.getFullYear(), endDay.getMonth(), endDay.getDate(), endDay.getHours(), tempMin + 14, 59);
	} else if (SelTerm == '30min') { // 30분
//		startTime = new Date(firstDay.setMinutes(firstDay.getMinutes() - 30));
		var startMin = (firstDay.getMinutes() >= 30)? 30:0;
		var endMin = (firstDay.getMinutes() >= 30)? 59:29;
		startTime = new Date(firstDay.getFullYear(), firstDay.getMonth(), firstDay.getDate(), firstDay.getHours(), startMin, 0);
		endTime = new Date(endDay.getFullYear(), endDay.getMonth(), endDay.getDate(), endDay.getHours(), endMin, 59);
	} else if (SelTerm == 'hour') { // 1시간
//		startTime = new Date(firstDay.setHours(firstDay.getHours() - 1));
		startTime = new Date(firstDay.getFullYear(), firstDay.getMonth(), firstDay.getDate(), firstDay.getHours(), 0, 0);
		endTime = new Date(endDay.getFullYear(), endDay.getMonth(), endDay.getDate(), endDay.getHours(), 59, 59);
	} else if (SelTerm == 'day') { // 오늘
//		startTime = new Date(firstDay.setDate(firstDay.getDate() - 1));
		startTime = new Date(firstDay.getFullYear(), firstDay.getMonth(), firstDay.getDate());
...
//		startTime = new Date(firstDay.setDate(firstDay.getDate() - 7));
		var weekSub = (firstDay.getDay() == 0)? 6 :firstDay.getDay() -1;
		var weekPls = (firstDay.getDay() == 0)? 0 :7 -firstDay.getDay();
		startTime = new Date(firstDay.getFullYear(), firstDay.getMonth(), firstDay.getDate() -weekSub);
		endTime = new Date(endDay.getFullYear(), endDay.getMonth(), endDay.getDate() +weekPls, 23, 59, 59);
	} else if (SelTerm == 'month') { // 1달
//		startTime = new Date(firstDay.setDate(firstDay.getDate() - 30));
		startTime = new Date(firstDay.getFullYear(), firstDay.getMonth(), 1);
		lastDay = (new Date(endDay.getFullYear(), endDay.getMonth() +1, 0)).getDate();
		endTime = new Date(endDay.getFullYear(), endDay.getMonth(), lastDay, 23, 59, 59);

	} else if (SelTerm == 'year') { // 1년
//		startTime = new Date(firstDay.setDate(firstDay.getDate() - 365));
		startTime = new Date(firstDay.getFullYear(), 0, 1);
		endTime = new Date(endDay.getFullYear(), 11, 31, 23, 59, 59);
//		lastTime = new Date(firstDay.getFullYear(), 11, 31, 23, 59, 59);
...
function setTickInterval() {
	...
	if(SelTerm == '30min') {
		...
		if (periodd == '15min') {
			...
			tickInterval = 30 * 60 * 1000;//15 * 60 * 1000;
		}
		...
		if (periodd == '15min') {
			...
			myChart.xAxis[0].options.labels.style.fontSize = '7px';
		} // 96
		else if (periodd == '30min') {
