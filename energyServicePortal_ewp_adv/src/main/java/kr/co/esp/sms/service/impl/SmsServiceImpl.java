package kr.co.esp.sms.service.impl;
...
import kr.co.esp.alarm.service.impl.AlarmMapper;
...
public class SmsServiceImpl extends EgovAbstractServiceImpl implements SmsService {
	...
	public void sendAlarmMessage(String siteId, String deviceId, String deviceName, String alarmTime, String alarmType, String alarmMsg) throws Exception {
		...
		List<Map<String, Object>> userList = alarmMapper.getSmsUserList(param);
...
//			body.add("M2", deviceName);
	 ...
	 * 인증번호 전송
	 */
	public int sendAuthCodeMessage(Map<String, Object> param) throws Exception {
	 ...
	 * 비밀번호 sms
	 */
	public int sendFindPassMessage(Map<String, Object> param) throws Exception {
