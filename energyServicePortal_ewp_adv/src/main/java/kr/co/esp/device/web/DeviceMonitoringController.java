...
import kr.co.esp.api.model.UsageRealtimeModel;
...
public class DeviceMonitoringController {
	...
	@RequestMapping(value = "/device/deviceMonitoring.do")
	public String deviceMonitoring(HttpServletRequest request, HttpSession session, Model model) {
		System.out.println("/device/deviceMonitoring.do");
		model.addAttribute("deviceGbn", request.getParameter("deviceGbn"));
		return "esp/device/deviceMonitoring";
	}
	
	@RequestMapping("/device/getDeviceIOEList.json")
	public @ResponseBody Map<String, Object> getDeviceIOEList(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDeviceIOEList.json");
		...
		List<Map<String, Object>> list = deviceMonitoringService.getDeviceIOEList(param);
	...
	@RequestMapping("/device/getDeviceIOEDetail.json")
	public @ResponseBody Map<String, Object> getDeviceIOEDetail(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDeviceIOEDetail.json");
		logger.debug("param ::::: " + param.toString());
		...
		if(!"9".equals(deviceType)) {
			...
			result.put("activePower", (amiModel == null) ? null : 1.732*((amiModel.getCurrentR()+amiModel.getCurrentS()+amiModel.getCurrentT())*380));				Float volS = amiModel.getVoltageS();
			result.put("energy", (amiModel == null) ? null : (amiModel.getAccumActivePowerR()+amiModel.getAccumActivePowerS()+amiModel.getAccumActivePowerT())/1000);				Float volT = amiModel.getVoltageT();
	...
	@RequestMapping("/device/getDevicePCSList.json")
	public @ResponseBody Map<String, Object> getDevicePCSList(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDevicePCSList.json");
		logger.debug("param ::::: " + param.toString());
		...
		List<Map<String, Object>> list = deviceMonitoringService.getDevicePCSList(param);
	...
	@RequestMapping("/device/getDevicePCSDetail.json")
	public @ResponseBody Map<String, Object> getDevicePCSDetail(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDevicePCSDetail.json");
		logger.debug("param ::::: " + param.toString());
...
//				}
	...
	@RequestMapping("/device/getDeviceBMSList.json")
	public @ResponseBody Map<String, Object> getDeviceBMSList(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDeviceBMSList.json");
		logger.debug("param ::::: " + param.toString());
		...
		List<Map<String, Object>> list = deviceMonitoringService.getDeviceBMSList(param);
	...
	@RequestMapping("/device/getDeviceBMSDetail.json")
	public @ResponseBody Map<String, Object> getDeviceBMSDetail(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDeviceBMSDetail.json");
		logger.debug("param ::::: " + param.toString());
...
//				}
	...
	@RequestMapping("/device/getDevicePVList.json")
	public @ResponseBody Map<String, Object> getDevicePVList(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDevicePVList.json");
		logger.debug("param ::::: " + param.toString());
		...
		List<Map<String, Object>> list = deviceMonitoringService.getDevicePVList(param);
	...
	@RequestMapping("/device/getDevicePVDetail.json")
	public @ResponseBody Map<String, Object> getDevicePVDetail(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDevicePVDetail.json");
		logger.debug("param ::::: " + param.toString());
