...
public class DeviceGroupController {
	...
	@RequestMapping(value = "/device/deviceGroup.do")
	public String deviceGroup(HttpServletRequest request, HttpSession session, Model model) {
		logger.debug("/device/deviceGroup.do");
		return "esp/device/deviceGroup";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/getDeviceGroupList.json")
	public @ResponseBody Map<String, Object> getDeviceGroupList(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDeviceGroupList.json");
		logger.debug("param ::::: {}", param);
		
		param.put("siteId", request.getSession().getAttribute("selViewSiteId"));
		List<Map<String, Object>> list = deviceGroupService.getDeviceGroupList(param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/getDvInDeviceGroupList.json")
	public @ResponseBody Map<String, Object> getDvInDeviceGroupList(@RequestParam Map<String, Object> param) throws Exception {
		logger.debug("/device/getDvInDeviceGroupList.json");
		logger.debug("param ::::: {}", param);
		
		List<Map<String, Object>> list = deviceGroupService.getDvInDeviceGroupList(param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/getDeviceGrpAlarmList.json")
	public @ResponseBody Map<String, Object> getDeviceGrpAlarmList(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDeviceGrpAlarmList.json");
		logger.debug("param ::::: {}", param);
		
		param.put("siteId", request.getSession().getAttribute("selViewSiteId"));
		param.put("alarmType", 1);
		List<Map<String, Object>> warningList = deviceGroupService.getDeviceGrpAlarmList(param);
		param.put("alarmType", 2);
		List<Map<String, Object>> alertList = deviceGroupService.getDeviceGrpAlarmList(param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/getDvInDeviceGroupPopupList.json")
	public @ResponseBody Map<String, Object> getDvInDeviceGroupPopupList(@RequestParam Map<String, Object> param) throws Exception {
		logger.debug("/device/getDvInDeviceGroupPopupList.json");
		logger.debug("param ::::: {}", param);
		
		List<Map<String, Object>> dvInDeviceGrouplist = deviceGroupService.getDvInDeviceGroupList(param);
		List<Map<String, Object>> allDvInSiteList = deviceGroupService.getAllDvInSiteList(param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/getDeviceNotInGroupList.json")
	public @ResponseBody Map<String, Object> getDeviceNotInGroupList(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDeviceNotInGroupList.json");
		logger.debug("param ::::: {}", param);
		
		param.put("siteId", request.getSession().getAttribute("selViewSiteId"));
		List<Map<String, Object>> deviceNotInGrouplist = deviceGroupService.getDeviceNotInGroupList(param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/saveDvInDvGrp.json")
	public @ResponseBody Map<String, Object> saveDvInDvGrp(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/saveDvInDvGrp.json");
		logger.debug("param ::::: {}", param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/insertDeviceGroup.json")
	public @ResponseBody Map<String, Object> insertDeviceGroup(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/insertDeviceGroup.json");
		logger.debug("param ::::: {}", param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/updateDeviceGroup.json")
	public @ResponseBody Map<String, Object> updateDeviceGroup(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/updateDeviceGroup.json");
		logger.debug("param ::::: {}", param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/deleteDeviceGroup.json")
	public @ResponseBody Map<String, Object> deleteDeviceGroup(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/deleteDeviceGroup.json");
		logger.debug("param ::::: {}", param);

		Map<String, Object> userInfo = UserUtil.getUserInfo(request);

		Map<String, Object> dvGrpMap = new HashMap<String, Object>();
		dvGrpMap.put("deviceGrpIdx", param.get("deviceGrpIdx"));
		List<Map<String, Object>> dvList = deviceGroupService.getDvInDeviceGroupList(dvGrpMap);
		int delDvCnt = 0;
		if(dvList.size() > 0) {
			for (Map<String, Object> dvMap : dvList) {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/insertDevice.json")
	public @ResponseBody Map<String, Object> insertDevice(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/insertDevice.json");
		logger.debug("param ::::: {}", param);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/deleteDevices.json")
	public @ResponseBody Map<String, Object> deleteDevices(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/deleteDevices.json");
		logger.debug("param ::::: {}", param);
		Map<String, Object> userInfo = UserUtil.getUserInfo(request);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/device/getDeviceGrpSitePopupList.json")
	public @ResponseBody Map<String, Object> getDeviceGrpSitePopupList(@RequestParam Map<String, Object> param, HttpServletRequest request) throws Exception {
		logger.debug("/device/getDeviceGrpSitePopupList.json");
		logger.debug("param ::::: {}", param);
