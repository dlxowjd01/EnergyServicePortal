 ...
 */
@Service("peakService")
public class PeakServiceImpl extends EgovAbstractServiceImpl implements PeakService {

	@Resource(name="peakMapper")
	private PeakMapper peakMapper;

	@Override
	public Map<String, Object> getPeakRealList(Map<String, Object> param, HttpServletRequest request) throws Exception {
		List<Map<String, Object>> list = peakMapper.getPeakRealList(param);
