...
$(function () {
    ...
    if(urlPathName === "/usage") workerPath = '../js/worker/usageWorker.js';
    else if(urlPathName === "/peak") workerPath = '../js/worker/peakWorker.js';
    else if(urlPathName === "/essCharge") workerPath = '../js/worker/essChargeWorker.js';
    else if(urlPathName === "/pvGen") workerPath = '../js/worker/pvGenWorker.js';
    else if(urlPathName === "/derUsage") workerPath = '../js/worker/derUsageWorker.js';
