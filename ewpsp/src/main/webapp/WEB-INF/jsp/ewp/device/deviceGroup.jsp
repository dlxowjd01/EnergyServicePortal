                                        ...
                                        <ul class="fl">
                                            <c:if test="${not empty userInfo and userInfo.auth_type eq '1'}">
                                                <li><a href="#;" class="default_btn" id="grpMngFormBtn"><i
                                                        class="glyphicon glyphicon-th-list"></i> 장치그룹관리</a></li>
                                            </c:if>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <form id="insertDeviceForm" name="insertDeviceForm">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><span>장치명</span></th>
                                    <td><input type="text" id="deviceName" name="deviceName" class="input"
                                               style="width:100%"></td>
                                </tr>
                                <tr>
                                    <th><span>장치ID</span></th>
                                    <td><input type="text" id="deviceId" name="deviceId" class="input"
                                               style="width:100%"></td>
                                </tr>
                                <tr>
        ...
        <div id="layerbox" class="dgdevice" style="min-width:800px;">
            ...
            <div class="lbody mt30">
                ...
                <div class="dgset_top clear">
                    ...
                    <a href="#;" class="default_btn fr" id="editDvGrpFormBtn"><i class="glyphicon glyphicon-edit"></i>
                        장치그룹편집</a>
                </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" id="deviceGrpName" name="deviceGrpName" class="input"
                                                   style="width:100%"></td>
                                    </tr>
                                </tbody>
                            </table>
