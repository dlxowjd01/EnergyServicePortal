  ...
  <body>
    <style>
      ...
      #page-wrapper .login {
        ...
        margin: 0;
        min-height: 800px;
        background: url('../img/login_bg_black.jpg') repeat center bottom;
      ...
      .lftit {
        padding-top: 110px;
        background: url('../img/login_people.png') no-repeat center 0;
      }
      ...
      .lf_body .arrbtn {
        ...
        padding-right: 30px;
        background: url('../img/login_arr_black.png') no-repeat right center;
        font-size: 14px;
        color: #777;
      }
          ...
          <div class="loginForm">
            <form id="loginForm" name="loginForm" action="/loginUser" method="post"
              ...
              <div class="lf_body">
                ...
                <div class="mt10"><input type="text" id="loginUserId" name="userId" class="lfinp"
                                         placeholder=<spring:message code="ewp.login.ID"/>></div>
                <div class="mt15"><input type="password" id="loginUserPw" name="userPw" class="lfinp"
                                         placeholder=<spring:message code="ewp.login.Password"/>></div>
                <div class="mt30">
                  <a href="#" class="findidBtn arrbtn"><spring:message
                    code="ewp.login.Forgot_account"/></a>
                  <a href="#" class="findpassBtn arrbtn ml30"><spring:message
                    code="ewp.login.Forgot_password"/></a>
                </div>
              </div>
              <div class="lf_bottom">
    ...
    <div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModal"
      ...
      <div class="modal-dialog">
        <div class="loginmodal-container">
          ...
          <form id="loginForm2" name="loginForm2" action="/loginUser" method="post"
                onsubmit="return checkLogin(this)">
    ...
    <!-- 로그인 modal // -->
    <!-- 아이디찾기 modal // -->
    <div class="modal fade" id="findidModal" tabindex="-1" role="dialog" aria-labelledby="findidModal"
        ...
        <div class="loginmodal-container">
          ...
          <form id="findForm" name="findForm">
            ...
            <div class="modal-body">
                      ...
                      <td>
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="mobileType">
                            SKT
                          </label>
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="mobileType">
                      ...
                      <td>
                        <div class="inputGroup">
                          ...
                          <input type="text" id="findMobile2" class="inp fl"
                                 maxlength="4" style="width:22%;"/>
                          <span class="inline center fl mt10"
                                style="width:2%;"> - </span>
                          <input type="text" id="findMobile3" class="inp fl"
                                 maxlength="4" style="width:22%;"/>
                          <span class="inline center fl"
                                style="width:2%;"> &nbsp; </span>
                          <button type="button" class="btnstyle middle white fl"
                                  style="width:28%; white-space:nowrap; vertical-align:top; overflow:hidden;"
                                  id="findAuthCodeBtn">인증번호 받기
                          </button>
                        </div>
                      </td>
                    </tr>
              ...
              <div class="mt20"><input type="submit" name="findpass" class="login loginmodal-submit"
                                       value="확인" id="findBtn"></div>
            </div>
          </form>
        </div>
      </div>
    ...
    <!-- 아이디찾기 modal // -->
    <!-- 비번찾기 modal // -->
    <div class="modal fade" id="findpassModal" tabindex="-1" role="dialog" aria-labelledby="findpassModal"
         aria-hidden="true" style="display: none;">
      <div class="modal-dialog">
        <div class="loginmodal-container">
          <div class="modal-header" style="padding:0 0 15px; margin:0 0 15px">
                        ...
                        <div class="inputGroup">
                          <select id="findPwMobile1" class="inp fl" style="width:22%;">
                            ...
                            <select>
                              <span class="inline center fl mt10"
                                    style="width:2%;"> - </span>
                              <input type="text" id="findPwMobile2" class="inp fl"
                                     maxlength="4" style="width:22%;"/>
                              <span class="inline center fl mt10"
                                    style="width:2%;"> - </span>
                              <input type="text" id="findPwMobile3" class="inp fl"
                                     maxlength="4" style="width:22%;"/>
                              <span class="inline center fl"
                                    style="width:2%;"> &nbsp; </span>
                              <button type="button" class="btnstyle middle white fl"
                                      style="width:28%; white-space:nowrap; vertical-align:top; overflow:hidden;"
                                      id="findPwAuthCodeBtn">인증번호 받기
                              </button>
                            </select>
                          </select>
                        </div>
              ...
              <div class="unit">
                ...
                <div class="unit_cont mt5">
                  <div class="termBox">
                    ...
                    <br>
                    제 1 조 (목적)<br>
                    본 약관은 동서발전 사이트가 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차, 이용자와 서비스포털 사이트의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로
                    합니다.<br>
                    <br>
                    제 2 조 (약관의 효력과 변경)<br>
                    1. 본약관에 동의 하는 경우 서비스포털 서비스 제공 행위 및 사용 행위에 본 약관이 우선적으로 적용됩니다.<br>
                    2. 서비스포털 서비스 약관을 개정할 경우, 적용일자 및 개정사유를 명시하여 현행 약관과 함께 홈페이지에 공지합니다. 변경된 약관은 서비스포털 서비스 내에 공지하고 공지와 동시에
                    그 효력이 발생되며 7일간 개정 내용 표시를 유지합니다.<br>
                    <br>
                    제 3 조 (약관 외 준칙)<br>
                    1. 서비스포털 사이트는 필요한 경우 각 개별 서비스 내에서의 약관 또는 운영정책, 각 서비스 상의 안내, 공지사항을 두어 개별 운영 원칙을 정할 수 있으며, 그 밖에 약관과
                    서비스별 운영원칙에 명시되지 않은 사항은 관련 법령의 규정에 의합니다.<br>
                    <br>
                    제 4 조 (용어의 정의)<br>
                    ...
                    제 5 조 (이용자의 정보 보안)<br>
                    1. 본인 개인정보 또는 타인의 개인정보를 무단 사용을 발견한 경우 즉시 서비스포털 사이트에 신고하여 개인정보 보호 관련 법령에 따라 안전하게 관리하여야 하며, 신고를 하지
                    않음으로 인한 피해와 모든 책임은 이용자 본인에게 있습니다.<br>
                    2. 이용자는 서비스포털 사이트 서비스를 종료하는 경우 회원 탈퇴를 진행하여야 하며, 회원 탈퇴를 하지 아니함으로써 발생되는 손해 및 손실에 대하여 서비스포털 사이트는 책임을
                    부담하지 아니합니다.<br>
                    제 6 조 (서비스의 중지)<br>
                    1. 서비스포털 사이트는 이용자가 운영정책 혹은 해당 약관 내용에 위배되는 행동 또는 관련 법령을 위반한 자는 서비스 이용을 즉시 영구 정지 시키며 이러한 이용 제한에도 불구하고
                    해당 서비스 이용계약의 온전한 유지를 기대하기 어려운 경우엔 부득이 이용자와의 계약 해지를 할 수 있습니다. 계약 해지에 따른 피해가 발생 할 경우 서비스 포털 사이트는 책임을
                    부담하지 아니합니다.<br>
                    제 7 조 (서비스의 변경 및 해지)<br>
                    1. 서비스포털 사이트의 서비스를 통한 손익이나 얻은 자료로 인한 배포 혹은 손해가 발생하는 경우 귀사에서 책임을 지지 않으며, 이용자가 본 서비스를 이용하여 사용하는 정보,
                    자료, 신뢰도, 정확도 등과 같은 내용에 대하여 귀사는 책임을 지지 않습니다.<br>
                    2. 서비스포털 사이트는 서비스 이용과 관련하여 이용자에게 발생한 손해 중 이용자의 고의, 과실에 의한 손해에 대하여 책임을 부담하지 아니합니다.<br>
                    제 8 조 (게시물의 저작권)<br>
                    1. 서비스포털 사이트는 자주하는 질문의 게시글에 대한 내용을 사전 통지 없이 편집 및 삭제 할 수 있는 권리를 보유하며, 운영원칙에 따라 사전 통지 없이 삭제할 수
                    있습니다.<br>
                    제 3 장 의무 및 책임<br>
                    제 9 조 (서비스포털 사이트의 의무)<br>
                    1. 서비스포털 사이트는 원할한 서비스 제공을 위해 이용자가 동의한 목적과 범위 내에서만 개인정보를 수집, 이용가능하며, 개인정보 보호 관련 법령에 따라 안전하게 관리합니다.
                    이용자 승낙 없이 개인정보를 타인에게 누설, 배포하지 않습니다. 다만 법률의 특별한 규정, 법령상 의무준수를 위해 불가피한 경우에는 그러하지 아니합니다.<br>
                    제 10 조 (이용자의 의무)<br>
                    1. 이용자는 서비스포털 사이트의 사전 동의 없이 서비스를 이용한 영리 행위를 할 수 없으며, 적발시 약관에 의거한 법률 및 규정, 의무 준수에 따라 이용해지를 할 수
                    있습니다.<br>
                    제 4 장 기타<br>
                    제 11 조 (손해배상)<br>
                    1. 서비스포털 사이트에서 제공되는 서비스와 관련하여 귀사의 고의 또는 과실로 인하여 손해를 입게 될 경우 관련 법령에 따라 손해를 배상 하지만 고의 또는 과실, 천재 지변,
                    예견이 불가능 하거나 특별한 사정으로 공지한 사항, 기타 징벌적 손해에 대해서는 관련 법령에 특별한 규정이 없는 한 책임을 부담하지 않습니다.<br>
                    제 12 조 (면책조항)<br>
                    1. 서비스포털 사이트는 이용자가 서비스에 담긴 정보를 사용하여 얻은 손익이나 손해에 대한 책임이 없습니다.<br>
                    2. 서비스포털 사이트는 이용자간 또는 이용자와 제3자간에 서비스를 매개로 하여 물품거래 혹은 금전적 거래 등과 관련하여 어떠한 책임도 부담하지 아니하고, 회원이 서비스의 이용과
                    관련하여 기대하는 이익에 관하여 책임을 부담하지 않습니다.<br>
                    제 13 조 (재판관할)<br>
                    1. 본 약관 또는 서비스포털 서비스와 관련된 이용자와의 관계에는 대한믹국의 법령이 적용되며, 분쟁이 발생하는 경우 그 분쟁의 처리는 대한민국 ‘민사소송법’에서 정한 절차를
                    따릅니다.<br>
                    <br>
                    ...
                    다만, 회원 본인이 직접 삭제하거나 수정한 정보, 가입해지를 요청한 경우에는 재생할 수 없는 방법에 의하여 디스크에서 완전히 삭제하며 추후 열람이나 이용이 불가능한 상태로
                    처리됩니다.<br>
    ...
    <!-- //회원가입 step01 // 동의부분 -->
    <!-- 회원가입 step02 //////////////////// 정보입력 -->
    <div class="modal fade" id="join2Modal" tabindex="-1" role="dialog" aria-labelledby="join2Modal"
         aria-hidden="true">
      <div class="modal-dialog modal-md">
        <!-- Modal content-->
        <div class="modal-content">
          ...
          <form id="joinForm" name="joinForm">
                    ...
                    <table class="tableStyle formStyle left">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="inputGroup">
                              <input type="text" id="joinUserId" name="userId"
                                     class="inp fl" style="width:78%;" maxlength="20"/>
                              <span class="inline center fl"
                                    style="width:2%;">&nbsp;</span>
                              <button type="button" class="btnstyle middle white fl"
                                      style="width:20%; white-space:nowrap; vertical-align:top; overflow:hidden;"
                                      id="duplicateBtn">중복확인
                              </button>
                            </div>
                        ...
                        <tr>
                          <th>비밀번호</th>
                          <td>
                            <input type="password" id="joinUserPw" name="userPw" class="inp"
                        ...
                        <tr>
                          <th>비밀번호확인</th>
                          <td>
                            <input type="password" id="joinUserPw2" class="inp"
                                   style="width:100%;" maxlength="100"/>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="inputGroup">
                              <input type="text" id="joinEmail1" class="inp fl"
                                     style="width:60%;" maxlength="25"/>
                              <span class="inline center fl" style="width:5%;">@</span>
                              <input type="text" id="joinEmail3" class="inp fl"
                                     style="width:27%; margin-right:10px; display:none;"
                                     maxlength="25"/>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="inputGroup">
                              <input type="text" id="joinMobile1" class="inp fl"
                                     style="width:30%;" maxlength="3"/>
                              <span class="inline center fl" style="width:5%;">-</span>
                              <input type="text" id="joinMobile2" class="inp fl"
                                     style="width:30%;" maxlength="4"/>
                              <span class="inline center fl" style="width:5%;">-</span>
                              <input type="text" id="joinMobile3" class="inp fl"
                                     style="width:30%;" maxlength="4"/>
                            </div>
                            <span class="helpCont">휴대폰번호를 입력해 주세요</span>
                            <span class="helpCont">숫자를 입력해 주세요</span>
                            <button type="button" class="btnstyle middle white fl"
                                    style="width:100%; white-space:nowrap; vertical-align:top; overflow:hidden; margin-top: 5px;"
                                    id="joinAuthCodeBtn">인증번호 받기
                            </button>
                          </td>
                        </tr>
                        <tr>
            ...
            <div class="modal-footer">
              <div style="padding:5px 0;text-align:center;">
                ...
                <button type="submit" class="join2nextBtn default_btn w80" data-dismiss="modal">확인
                </button>
              </div>
            </div>
          </form>
...
//			$("#join3Modal").modal("show");
    ...
    <!-- //회원가입 step02 // 정보입력 -->
    <!-- 회원가입 step03 //////////////////// 가입완료 -->
    <div class="modal fade" id="join3Modal" tabindex="-1" role="dialog" aria-labelledby="join3Modal"
         aria-hidden="true">
      <div class="modal-dialog modal-md">
        <!-- Modal content-->
        <div class="modal-content">
            ...
            <div id="svCompany" class="joinBox svCompany">
              ...
              <div class="sec">
                ...
                <div class="sec_cont">
                  ...
                  <p class="mt5">
                    IoT 기기와 연계한 각각의 고객 사이트와 전체 사이트의 실시간, 과거의 사용량과 미래의 예측량을 모니터링 하고 충/방전량, ESS 서비스를
                    통한 실적 및 수익 정보를 조회할 수 있는 서비스 포털 서비스입니다.
                  </p>
                </div>
              </div>
              <!-- 주요 서비스 -->
              <div class="sec mt30">
                ...
                <div class="sec_cont clear mt20">
                  ...
                  <div class="fr">
                    ...
                    <p class="mt5 tint">※ 에너지 모니터링 – 전력 사용량 현황, 피크 전력 현황, 충/방전 현황, PV 발전량 현황, DR실적
                      현황, 사용량 구성(DER)</p>
