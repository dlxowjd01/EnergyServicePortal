                        ...
                        <div class="col-lg-12">
                            <div class="indiv control clear">
                                ...
                                <div class="clear mt30">
                                    <a href="javascript:popupOpen('rpeople');" class="fr default_btn"
                                       id="smsSendMngBtn"><i class="glyphicon glyphicon-phone"></i> 알람전송 관리</a>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" id="alarmNote" name="alarmNote" class="input"
                                                   style="width:100%"></td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" id="addresseeName" name="addresseeName" class="input"
                                                   style="width:100%; display: none;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th><span>연락처</span></th>
                                        <td><input type="text" id="mobile" name="mobile" class="input"
                                                   style="width:100%" placeholder="'-'를 제외한 연락처 입력" maxlength="11"
                                                   onkeydown="onlyNum(event);"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </form>
