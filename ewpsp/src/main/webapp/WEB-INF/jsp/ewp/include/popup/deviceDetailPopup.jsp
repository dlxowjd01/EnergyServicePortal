...
<script type="text/javascript">
    ...
    function drawIOEDetail(result) {
        ...
        ioeStr += '<tbody>';
        ioeStr += '<tr>';
        ioeStr += '<td>' + ((ioeDetail.voltage == null) ? "-" : toFixedNum(Number(ioeDetail.voltage) , 2)) + '</td>';
        ioeStr += '<td>' + ((ioeDetail.activePower == null) ? "-" : toFixedNum(Number(ioeDetail.activePower) , 2)) + '</td>';
        ioeStr += '<td>' + ((ioeDetail.energy == null) ? "-" : toFixedNum(Number(ioeDetail.energy) , 2)) + '</td>';
        ioeStr += '<td>' + ((ioeDetail.energyReactive == null) ? "-" : toFixedNum(Number(ioeDetail.energyReactive) , 2)) + '</td>';
        ioeStr += '</tr>';
        ioeStr += '</tbody>';
        ioeStr += '</table>';
        ioeStr += '</div>';
