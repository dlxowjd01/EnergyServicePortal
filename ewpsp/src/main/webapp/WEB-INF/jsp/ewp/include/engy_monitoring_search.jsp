...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
							...
							<c:if test="${param.schGbn ne 'energy_drResult' }">
								...
								<div class="term fl clear">
									<div class="dropdown fl">
									  ...
									  <ul class="dropdown-menu">
									    ...
									    <li><a href="#" onclick="changeSelTerm('30min'); ">30분</a></li>
									...
									<div class="dropdown fl">
									  ...
									  <ul class="dropdown-menu">
									    ...
									    <li id="sp_15min" onclick="changePeriod('15min');"><a href="#">15분</a></li>
							...
							<c:if test="${param.schGbn eq 'energy_drResult' }">
							<div class="chart_top clear">
								<h2 class="ntit fl">롯데정밀화학</h2>
								<div class="term fl clear">
									<div class="dropdown fl">
							...
							<!-- <input type="hidden" id="schTermFrom" name="schTermFrom">
							<input type="hidden" id="schTermTo" name="schTermTo"> -->
