                ...
                <div class="term fl clear">
                    <div class="dropdown fl">
                        ...
                        <ul class="dropdown-menu">
                            <li class="on"><a href="#"
                                              onclick="selectBoxTextApply(this);changeSelTerm('drday');">1일(오늘)</a></li>
                            <li><a href="#" onclick="selectBoxTextApply(this);changeSelTerm('selectDay');">1일(날짜선택)</a>
                            </li>
                        </ul>
                    </div>
                    <div class="dropdown fl">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li id="sp_1hour"><a href="#"
                                                 onclick="selectBoxTextApply(this);changePeriod('hour');">1시간</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="chart_top clear">
                ...
                <div class="dropdown fl">
                    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"
                        ...
                        <span class="caret"></span></button>
                    <ul class="dropdown-menu">
                        <li class="on"><a href="#" onclick="selectBoxTextApply(this);changeSelTerm('30min'); ">30분</a>
                        </li>
