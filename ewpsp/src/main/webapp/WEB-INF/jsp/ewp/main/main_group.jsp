    ...
    <body>
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr class="dbclickopen">
                                                        <td>1</td>
                                                        <td>
                                                            <div class="cname"><a href="../main/smain.html">롯데정밀화학Z</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="eq_icon">
                                                    ...
                                                    <tr class="dbclickopen">
                                                        <td>2</td>
                                                        <td>
                                                            <div class="cname"><a href="../main/smain.html">한국프랜지</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="eq_icon">
                                                    ...
                                                    <tr class="dbclickopen">
                                                        <td>3</td>
                                                        <td>
                                                            <div class="cname"><a href="../main/smain.html">제일화성</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="eq_icon">
                                                    ...
                                                    <tr class="dbclickopen">
                                                        <td>4</td>
                                                        <td>
                                                            <div class="cname"><a href="../main/smain.html">한국제지</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="eq_icon">
                                                    ...
                                                    <tr class="dbclickopen">
                                                        <td>5</td>
                                                        <td>
                                                            <div class="cname"><a href="../main/smain.html">문수경기장</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="eq_icon">
                                                    ...
                                                    <tr class="dbclickopen">
                                                        <td>6</td>
                                                        <td>
                                                            <div class="cname"><a href="../main/smain.html">태광석유화학</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="eq_icon">
                                                    ...
                                                    <tr class="dbclickopen">
                                                        <td align="left">7</td>
                                                        <td>
                                                            <div class="cname"><a href="../main/smain.html">SNF
                                                                KOREA</a></div>
                                                        </td>
                                                        <td>
                                                            <div class="eq_icon">
                                                    ...
                                                    <tr class="dbclickopen">
                                                        <td>8</td>
                                                        <td>
                                                            <div class="cname"><a href="../main/smain.html">롯데정밀화학</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="eq_icon">
        ...
        <script type="text/javascript">
            ...
            function local_detail(lname) {
                ...
                if (lname == "Seoul") {
                    $(".detailmap .local_name").text("서울");
                }
                if (lname == "Gyeonggi") {
                    $(".detailmap .local_name").text("경기");
                }
                if (lname == "Incheon") {
                    $(".detailmap .local_name").text("인천");
                }
                if (lname == "Gangwon") {
                    $(".detailmap .local_name").text("강원");
                }
                if (lname == "Chungbuk") {
                    $(".detailmap .local_name").text("충북");
                }
                if (lname == "Daejeon") {
                    $(".detailmap .local_name").text("대전");
                }
                if (lname == "Chungnam") {
                    $(".detailmap .local_name").text("충남");
                }
                if (lname == "Kyungbuk") {
                    $(".detailmap .local_name").text("경북");
                }
                if (lname == "Daegu") {
                    $(".detailmap .local_name").text("대구");
                }
                if (lname == "Ulsan") {
                    $(".detailmap .local_name").text("울산");
                }
                if (lname == "Ulleungdo") {
                    $(".detailmap .local_name").text("울릉도");
                }
                if (lname == "Gyeongnam") {
                    $(".detailmap .local_name").text("경남");
                }
                if (lname == "Busan") {
                    $(".detailmap .local_name").text("부산");
                }
                if (lname == "Jeonbuk") {
                    $(".detailmap .local_name").text("전북");
                }
                if (lname == "Gwangju") {
                    $(".detailmap .local_name").text("광주");
                }
                if (lname == "Jeonnam") {
                    $(".detailmap .local_name").text("전남");
                }
                if (lname == "Jeju") {
                    $(".detailmap .local_name").text("제주");
                }
            }
