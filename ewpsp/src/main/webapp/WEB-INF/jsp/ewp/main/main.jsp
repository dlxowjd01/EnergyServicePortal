                                    ...
                                    <div class="indiv gmain_alarm">
                                        <div class="chart_top clear">
                                            ...
                                            <div class="fr today_alarm">
                                                <div class="total"><spring:message
                                                        code="ewp.main.Occurence_today"/><span
                                                        id="todayTotalAlarmCnt">0</span></div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="indiv gmain_chart">
                                        <ul class="gtab_menu">
                                            <li class="active" onclick="changeRanking(0);"><a
                                                    href="#;"><spring:message code="ewp.main.Usage"/></a></li>
                                            <li onclick="changeRanking(1);"><a href="#;"><a
                                                    href="#;"><spring:message code="ewp.main.Charging_discharging"/></a>
                                            </li>
                                            <li onclick="changeRanking(2);"><a href="#;"><spring:message
                                                    code="ewp.main.Power_generation"/></a></li>
                                            <li onclick="changeRanking(3);"><a href="#;"><spring:message
                                                    code="ewp.main.Revenue"/></a></li>
                                        </ul>
                                        <div class="tblDisplay">
                                            <!-- 사용 -->
                                            <div>
                                                <div class="gchart_top clear">
                                                    <h2 id="tabText"><spring:message code="ewp.main.Rank_usage"/>
                                                        (kWh)</h2>
                                                    <ul>
                                                        <li id="rankTime"><!-- AM 10:00 기준 --></li>
                                                        <li id="rankTotal">
                                                            <!-- <span class="bul1">누적 - 0.00 kWh</span> --></li>
                                                        <li id="rankPlan">
                                                            <!-- <span class="bul2">예상 - 0.00 kWh</span> --></li>
                                                    </ul>
                                                </div>
                                                <div class="inchart">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div id="mapUsage" class="indiv gmain_map">
                                        <div class="chart_top clear">
                                            ...
                                            <a href="#;" class="default_btn fr all_map_view"><span><spring:message
                                                    code="ewp.main.Whole_area"/></span></a>
                                        </div>
                                        <div class="map_wrap">
                                            ...
                                            <map name="local_map_all" id="local_map_all">
                                                <area href="javascript:local_detail('Busan', 2)" alt="Busan"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Jeonbuk', 13)" alt="Jeonbuk"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Jeonnam', 14)" alt="Jeonnam"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Daegu', 3)" alt="Daegu"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Daejeon', 6)" alt="Daejeon"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Gangwon', 10)" alt="Gangwon"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Gwangju', 5)" alt="Gwangju"
                                                      shape="poly"
                                                      coords="99,490,103,491,106,489,110,490,114,491,116,495,116,498,113,501,109,502,105,501,101,498,98,494,98,492"
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Gyeongnam', 16)" alt="Gyeongnam"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Jeju', 17)" alt="Jeju" shape="poly"
                                                      coords="38,709,91,695,109,705,112,719,89,738,67,744,24,744,17,730"
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Chungnam', 12)" alt="Chungnam"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Chungbuk', 11)" alt="Chungbuk"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Kyungbuk', 15)" alt="Kyungbuk"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Ulsan', 7)" alt="Ulsan"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Ulleungdo', 18)" alt="Ulleungdo"
                                                      shape="poly" coords="434,156,433,167,449,173,449,152"
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Seoul', 1)" alt="Seoul"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Incheon', 4)" alt="Incheon"
                                                      shape="poly"
                                                      ...
                                                      onfocus='this.blur()'/>
                                                <area href="javascript:local_detail('Gyeonggi', 9)" alt="Gyeonggi"
                                                      shape="poly"
                                            ...
                                            <div class="clear">
                                                <ul>
                                                    <li><strong><spring:message
                                                            code="ewp.main.The_amount_usage"/></strong> <span
                                                            class="detailUsage">0</span> <em
                                                            class="detailUsageUnit">MWh</em></li>
                                                    <li><strong><spring:message
                                                            code="ewp.main.The_amount_power_generation"/></strong> <span
                                                            class="detailGen">0</span> <em
                                                            class="detailGenUnit">MWh</em></li>
                                                </ul>
                                                <ul>
                                                    <li><strong><spring:message
                                                            code="ewp.main.The_amount_charging_discharging"/></strong>
                                                        <span class="detailCharge">0</span> <em
                                                                class="detailChargeUnit">MWh</em></li>
                                                    <li><strong><spring:message code="ewp.main.Revenue"/></strong> <span
                                                            class="detailReward">0</span> <em class="detailRewardUnit">won</em>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="local_info detailmap">
                                            ...
                                            <div class="clear">
                                                <ul>
                                                    <li><strong><spring:message
                                                            code="ewp.main.The_amount_usage"/></strong></strong> <span
                                                            class="detailUsage">0</span> <em
                                                            class="detailUsageUnit">MWh</em></li>
                                                    <li><strong><spring:message
                                                            code="ewp.main.The_amount_power_generation"/></strong> <span
                                    ...
                                    <div id="groupUsage" class="indiv gmain_group" style="display:none">
                                        ...
                                        <div class="group_wrap">
                                            <img id="grpImg" src="" onError="this.src='../img/group_dimg.png';"
                                                 alt="그룹이미지"/>
                                        </div>
                                        <!-- 그룹별 정보 -->
                                        <div class="group_info">
                                            ...
                                            <div class="clear">
                                                <ul>
                                                    <li><strong><spring:message
                                                            code="ewp.main.The_amount_usage"/></strong> <span
                                                            class="detailUsage">564</span> <em class="detailUsageUnit">MWh</em>
                                                    </li>
                                                    <li><strong><spring:message
                                                            code="ewp.main.The_amount_power_generation"/></strong> <span
                                                            class="detailGen">328</span> <em
                                                            class="detailGenUnit">MWh</em></li>
                                                </ul>
                                                <ul>
                                                    <li><strong><spring:message
                                                            code="ewp.main.The_amount_charging_discharging"/></strong>
                                                        <span class="detailCharge">183</span> <em
                                                                class="detailChargeUnit">MWh</em></li>
                                                    <li><strong><spring:message code="ewp.main.Revenue"/></strong> <span
                                                            class="detailReward">99,000</span> <em
                                                            class="detailRewardUnit">won</em></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="indiv gmain_table">
                                        <div class="term_menu clear">
                                            <ul>
                                                <li class="on"><a href="javascript:changeTerm('day')"><spring:message
                                                        code="ewp.main.Today"/></a></li>
                                                <li><a href="javascript:changeTerm('week')"><spring:message
                                                        code="ewp.main.This_week"/></a></li>
                                                <li><a href="javascript:changeTerm('month')"><spring:message
                                                        code="ewp.main.This_month"/></a></li>
                                            </ul>
                                            <ol>
                                                <li>
                                                    <div class="dropdown">
                                                        <button class="btn btn-primary dropdown-toggle" type="button"
                                                                ...
                                                                id="selMapGroup"><spring:message
                                                                code="ewp.main.Regional"/></em>
                                                            <span class="caret"></span></button>
                                                        <ul class="dropdown-menu">
                                                            <li class="on"><a href="#;"
                                                                              onclick="changeMapGroup(this)"><spring:message
                                                                    code="ewp.main.Regional"/></a></li>
                                                            <li><a href="#;"
                                                                   onclick="changeMapGroup(this)"><spring:message
                                                                    code="ewp.main.Groupby"/></a></li>
                                                        </ul>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="dropdown">
                                                        <button id="allAreaDiv" class="btn btn-primary dropdown-toggle"
                                                                type="button" data-toggle="dropdown"><em
                                                                id="selAllArea">
                                                            <spring:message code="ewp.main.Whole_area" /><!-- 전체지역 --></em>
                                                            <span class="caret"></span></button>
                                                        <ul id="selAreaList" class="dropdown-menu">
                                                            <li class="on"><a href="#;"
                                                                              onclick="changeAllArea(this, 'All', 0)">
                                                                <spring:message code="ewp.main.Whole_area" /><!-- 전체지역 --></a>
                                                            </li>
                                                            <li><a href="#;" onclick="changeAllArea(this, 'Seoul', 1)">
                                                                <spring:message code="ewp.main.Seoul" /><!-- 서울 --></a>
                                                            </li>
                                                            <li><a href="#;" onclick="changeAllArea(this, 'Busan', 2)">
                                                                <spring:message code="ewp.main.Busan" /><!-- 부산 --></a>
                                                            </li>
                                                            <li><a href="#;" onclick="changeAllArea(this, 'Daegu', 3)">
                                                                <spring:message code="ewp.main.Daegu" /><!-- 대구 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Incheon', 4)">
                                                                <spring:message code="ewp.main.Incheon" /><!-- 인천 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Gwangju', 5)">
                                                                <spring:message code="ewp.main.Gwangju" /><!-- 광주 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Daejeon', 6)">
                                                                <spring:message code="ewp.main.Daejeon" /><!-- 대전 --></a>
                                                            </li>
                                                            <li><a href="#;" onclick="changeAllArea(this, 'Ulsan', 7)">
                                                                <spring:message code="ewp.main.Ulsan" /><!-- 울산 --></a>
                                                            </li>
                                                            <li style="display:none"><a href="#;"
                                                                                        onclick="changeAllArea(this, 'Sejong', 8)">
                                                                <spring:message code="ewp.main.Sejong" /><!-- 세종 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Gyeonggi', 9)">
                                                                <spring:message code="ewp.main.Gyeonggi" /><!-- 경기 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Gangwon', 10)">
                                                                <spring:message code="ewp.main.Gangwon" /><!-- 강원 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Chungbuk', 11)">
                                                                <spring:message code="ewp.main.Chungbuk" /><!-- 충북 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Chungnam', 12)">
                                                                <spring:message code="ewp.main.Chungnam" /><!-- 충남 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Jeonbuk', 13)">
                                                                <spring:message code="ewp.main.Jeonbuk" /><!-- 전북 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Jeonnam', 14)">
                                                                <spring:message code="ewp.main.Jeonnam" /><!-- 전남 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Kyungbuk', 15)">
                                                                <spring:message code="ewp.main.Gyeongbuk" /><!-- 경북 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Gyeongnam', 16)">
                                                                <spring:message code="ewp.main.Gyeongnam" /><!-- 경남 --></a>
                                                            </li>
                                                            <li><a href="#;" onclick="changeAllArea(this, 'Jeju', 17)">
                                                                <spring:message code="ewp.main.Jeju" /><!-- 제주 --></a>
                                                            </li>
                                                            <li><a href="#;"
                                                                   onclick="changeAllArea(this, 'Ulleungdo', 18)">
                                                                <spring:message code="ewp.main.Ulleung" /><!-- 울릉도 --></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </li>
                                            ...
                                            <table>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><spring:message
                                                                code="ewp.main.Charging_discharging_th"/><br></th>
...
// 	                format: '{y} kWh', /* 단위 넣기 */
        ...
        <script type="text/javascript">
            ...
            function local_detail(lname, area_type) {
                ...
                if (lname == "Seoul") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Seoul" />');
                }/* "서울" */
                if (lname == "Gyeonggi") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Gyeonggi" />');
                }/* "경기" */
                if (lname == "Incheon") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Incheon" />');
                }/* "인천" */
                if (lname == "Gangwon") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Gangwon" />');
                }/* "강원" */
                if (lname == "Chungbuk") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Chungbuk" />');
                }/* "충북" */
                if (lname == "Daejeon") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Daejeon" />');
                }/* "대전" */
                if (lname == "Chungnam") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Chungnam" />');
                }/* "충남" */
                if (lname == "Kyungbuk") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Gyeongbuk" />');
                }/* "경북" */
                if (lname == "Daegu") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Daegu" />');
                }/* "대구" */
                if (lname == "Ulsan") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Ulsan" />');
                }/* "울산" */
                if (lname == "Sejong") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Sejong" />');
                }/* "세종" */
                if (lname == "Gyeongnam") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Gyeongnam" />');
                }/* "경남" */
                if (lname == "Busan") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Busan" />');
                }/* "부산" */
                if (lname == "Jeonbuk") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Jeonbuk" />');
                }/* "전북" */
                if (lname == "Gwangju") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Gwangju" />');
                }/* "광주" */
                if (lname == "Jeonnam") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Jeonnam" />');
                }/* "전남" */
                if (lname == "Jeju") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Jeju" />');
                }/* "제주" */
                if (lname == "Ulleungdo") {
                    $(".detailmap .local_name").text('<spring:message code="ewp.main.Ulleung" />');
                }/* "울릉도" */
            ...
            function readArea() {
                ...
                setTimeout(function () {
                    ...
                    if (area_array[area_idx] == "Seoul") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Seoul" />');
                    }/* "서울" */
                    if (area_array[area_idx] == "Busan") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Busan" />');
                    }/* "부산" */
                    if (area_array[area_idx] == "Daegu") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Daegu" />');
                    }/* "대구" */
                    if (area_array[area_idx] == "Incheon") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Incheon" />');
                    }/* "인천" */
                    if (area_array[area_idx] == "Gwangju") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Gwangju" />');
                    }/* "광주" */
                    if (area_array[area_idx] == "Daejeon") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Daejeon" />');
                    }/* "대전" */
                    if (area_array[area_idx] == "Ulsan") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Ulsan" />');
                    }/* "울산" */
                    if (area_array[area_idx] == "Sejong") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Sejong" />');
                    }/* "세종" */
                    if (area_array[area_idx] == "Gyeonggi") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Gyeonggi" />');
                    }/* "경기" */
                    if (area_array[area_idx] == "Gangwon") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Gangwon" />');
                    }/* "강원" */
                    if (area_array[area_idx] == "Chungbuk") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Chungbuk" />');
                    }/* "충북" */
                    if (area_array[area_idx] == "Chungnam") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Chungnam" />');
                    }/* "충남" */
                    if (area_array[area_idx] == "Jeonbuk") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Jeonbuk" />');
                    }/* "전북" */
                    if (area_array[area_idx] == "Jeonnam") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Jeonnam" />');
                    }/* "전남" */
                    if (area_array[area_idx] == "Kyungbuk") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Gyeongbuk" />');
                    }/* "경북" */
                    if (area_array[area_idx] == "Gyeongnam") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Gyeongnam" />');
                    }/* "경남" */
                    if (area_array[area_idx] == "Jeju") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Jeju" />');
                    }/* "제주" */
                    if (area_array[area_idx] == "Ulleungdo") {
                        $(".allmap .local_name").text('<spring:message code="ewp.main.Ulleung" />');
                    }/* "울릉도" */
...
// 	}
            ...
            function readSiteGrp() {
                if (done) return;
                if (siteGrp_idx == siteGrp_array.length) {
                    siteGrp_idx = 0;
                }
