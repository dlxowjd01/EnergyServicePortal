                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="indiv smain_soc">
                                        <div class="chart_top clear">
                                            <h2 class="ntit fl" ondblclick="location.href='/essCharge'"
                                                style="cursor: pointer;">
                                                <spring:message code="ewp.site.SOC" /><!-- SOC (잔량) --></h2>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="indiv der">
                                        <div class="chart_top clear">
                                            <h2 class="ntit fl" ondblclick="location.href='/derUsage'"
                                                style="cursor: pointer;">
                                                <spring:message code="ewp.site.Usage_composition" /><!-- 사용량 구성 (DER) --></h2>
                                        ...
                                        <div class="chart_footer">
                                            <ul class="clear">
                                                <li><spring:message code="ewp.site.Current_usage" /><!-- 현재 사용량 -->
                                                    <span id="nowUsage">0kWh</span></li>
                                                <li>PV <span id="pvPer">0%</span></li>
                                                <li>ESS <span id="essPer">0%</span></li>
                                                <li><spring:message code="ewp.site.KEPCO" /><!-- 한전 --> <span
                                                        id="kepcoPer">0%</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="indiv peak">
                                        <div class="chart_top clear">
                                            <h2 class="ntit fl" ondblclick="location.href='/peak'"
                                                style="cursor: pointer;">
                                                <spring:message code="ewp.site.Peak_demand_status" /><!-- 피크전력현황 --></h2>
                                        ...
                                        <div class="chart_notice"><strong><spring:message
                                                code="ewp.site.Time_not_covered_rate_plan"/></strong>
                                            <!-- 요금적용전력 제외시간 --> <span>(23:00 ~ 09:00)</span></div>
                                        <!-- no-data { -->
                                        <div class="no-data" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="indiv smain_device">
                                        <div class="chart_top clear">
                                            <h2 class="ntit fl" ondblclick="location.href='/deviceGroup'"
                                                style="cursor: pointer;">
                                                <spring:message code="ewp.site.Device_status" /><!-- 장치현황 --></h2>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="indiv income">
                                        ...
                                        <div class="chart_footer">
                                            <ul class="clear">
                                                <li><spring:message code="ewp.site.Total_revenue" /><!-- 전체수익 --> <span
                                                        id="totalRv">0 won</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="indiv charge">
                                        <div class="chart_top clear">
                                            <h2 class="ntit fl" ondblclick="location.href='/essCharge'"
                                                style="cursor: pointer;">
                                                <spring:message code="ewp.main.The_amount_charging_discharging" /><!-- 충/방전량 --></h2>
