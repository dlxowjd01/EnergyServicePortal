	...
	<div class="modal fade" id="findpassModal" tabindex="-1" role="dialog" aria-labelledby="findpassModal" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
			<div class="loginmodal-container">
			    ...
			    <div class="login-help">
				    <a href="#;" class="LoginReBtn">Login</a></a>
			    </div>
			</div>
		</div>
	</div>
										...
										<tr>
											...
											<td>
												<div class="inputGroup">
													...
													<button type="button" class="btnstyle middle white fl" style="width:20%;vertical-align:top;">중복검색</button>										
												</div>
	...
	<div class="modal fade" id="join3Modal" tabindex="-1" role="dialog" aria-labelledby="join3Modal" aria-hidden="true">
	    <div class="modal-dialog modal-md">
	        ...
	        <div class="modal-content">
	            ...
	            <div class="modal-footer">
	            	<div style="padding:5px 0;text-align:center;">
	            		<button type="button" class="login2Btn default_btn w80" data-dismiss="modal">로그인</button>
	            	</div>	                
	            </div>
	        </div>
	    </div>
