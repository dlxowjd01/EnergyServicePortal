            ...
            function callback_getDERUsageList(result) {
                ...
                if (!(kepcoUsageSheetList == null && essUsageListSheetList == null && pvUsageListSheetList == null)) {
                    ...
                    for (var i = 0; i < loopCntSheetList.length; i++) {
                        ...
                        dt_str += "<td>" + ((reKepcoUsage == null) ? "" : reKepcoUsage) + "</td>"; // 한전 사용량
                        dt_str2 += "<td>" + ((reEssUsage == null) ? "" : reEssUsage) + "</td>"; // ess 사용량
                        dt_str3 += "<td>" + ((rePvUsage == null) ? "" : rePvUsage) + "</td>"; // pv 사용량
                        dt_str4 += "<td>" + ((reTotalUsage == null) ? "" : reTotalUsage) + "</td>"; // 사용량 합계
                        ...
                        <div class="col-lg-12">
                            <div class="indiv">
                                <div class="tbl_top clear">
                                    ...
                                    <ul class="fr">
                                        <li>
                                            <div class="hl_tot_per" id="kepcoPer">한전 사용 <span>0%</span></div>
                                        </li>
                                        <li>
                                            <div class="tot_per" id="essPer">ESS 사용 <span>0%</span></div>
                                        </li>
                                        <li>
                                            <div class="tot_per" id="pvPer">PV 사용 <span>0%</span></div>
                                        </li>
                                        <li><a href="#;" class="save_btn"
                                               onclick="excelDownload('사용량구성', event);">데이터저장</a></li>
