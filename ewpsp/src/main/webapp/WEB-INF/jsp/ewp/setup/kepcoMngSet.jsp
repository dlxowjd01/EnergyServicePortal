                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="" id="" class="input"
                                                               value="${selViewSite.site_name }" disabled="disabled">
                                                    </td>
                                                    <th><span>고객 번호</span></th>
                                                    <td>
                                                        <input type="text" name="custNum" id="custNum" class="input"
                                                               value="" maxlength="20">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <input type="text" name="useElecAddr" id="useElecAddr"
                                                               class="input" style="width:100%" value=""
                                                               maxlength="120">
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="meterNum" id="meterNum" class="input"
                                                               value="" maxlength="20">
                                                    </td>
                                                    <th><span>계량기 배수</span></th>
                                                    <td>
                                                        <input type="text" name="meterSf" id="meterSf" class="input"
                                                               value="" maxlength="11" onkeydown="onlyNum(event);">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><span>계약 전력</span></th>
                                                    <td>
                                                        <input type="text" name="contractPower" id="contractPower"
                                                               class="input" value="" maxlength="11"
                                                               onkeydown="onlyNum(event);"> kW
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="text" name="reduceAmt" id="reduceAmt" class="input"
                                                               value="" maxlength="11" onkeydown="onlyNum(event);"> kW
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- 달력 스크립트 -->
                                                        <input type="text" id="datepicker10" class="sel" value=""
                                                               style="width:130px;">
                                                        <input type="hidden" id="chargeYearmd" name="chargeYearmd">
                                                        <input type="text" name="chargePower" id="chargePower"
                                                               class="input" maxlength="11" value=""> kW
                                                    </td>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="essBattery" id="essBattery"
                                                               class="input" value=""> kWh
                                                    </td>
                                                    <th><span>PCS</span></th>
                                                    <td>
                                                        <input type="text" name="essPcs" id="essPcs" class="input"
                                                               value=""> kW
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- 달력 스크립트 -->
                                                        <input type="text" id="datepicker11" class="sel" value=""
                                                               style="width:130px;">
                                                        <input type="hidden" id="recRateDate" name="recRateDate">
                                                        <input type="text" name="recRate" id="recRate" class="input"
                                                               value=""> 원/REC
                                                    </td>
                                                    <th><span>SMP 단가</span></th>
                                                    <td>
                                                        <!-- 달력 스크립트 -->
                                                        <input type="text" id="datepicker12" class="sel" value=""
                                                               style="width:130px;">
                                                        <input type="hidden" id="smpRateDate" name="smpRateDate">
                                                        <input type="text" name="smpRate" id="smpRate" class="input"
                                                               value=""> 원/kWh
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="recWeight" id="recWeight" class="input"
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="essProfitRatio" id="essProfitRatio"
                                                               class="input" value="" style="width:130px;" maxlength="2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="drProfitRatio" id="drProfitRatio"
                                                               class="input" value="" style="width:130px;" maxlength="2"
                                                               onkeydown="onlyNum(event);"> %
                                                    </td>
                                                    <th></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="pvProfitRatio" id="pvProfitRatio"
                                                               class="input" value="" style="width:130px;" maxlength="2"
                                                               onkeydown="onlyNum(event);"> %
                                                    </td>
                                                    <th></th>
