                        ...
                        <div class="col-lg-12">
                            <div class="indiv">
                                <div class="set_top clear">
                                    <a href="#;" class="adduser_btn fr" id="insertFormBtn"><i
                                            class="glyphicon glyphicon-user"></i> 사용자 추가하기</a>
                                </div>
                                <div class="s_table">
                                    <table>
                                        <colgroup>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="userId" id="userId" class="input" style="width:100%">
                                    </td>
                                </tr>
                                <tr>
                                    <th><span>권한</span></th>
                                ...
                                <tr>
                                    <th><span>설명</span></th>
                                    <td>
                                        <textarea name="note" id="note" style="width:100%" class="textarea"
                                                  rows="10"></textarea>
                                    </td>
                                </tr>
                            </tbody>
