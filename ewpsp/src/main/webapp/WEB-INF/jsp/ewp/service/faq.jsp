                            ...
                            <div class="indiv faq">
                                    ...
                                    <div class="infield">
                                        <form id="schForm" name="schForm">
                                            ...
                                            <input type="image" src="../img/search.png"
                                                   onclick="getDBData(); return false;">
                                        </form>
                                    </div>
                                </div>
                                <div class="faq_table mt30">
                                    <div class="cate" id="cateList">
                                        ...
                                        <c:forEach var="item" items="${faqCateList}">
                                            <a href="#;"
                                               onclick="changeFAQCate(this, '${item.faq_cate_idx}')">${item.faq_cate_name}</a>
                                        </c:forEach>
                                    </div>
                                ...
                                <c:if test="${not empty userInfo and userInfo.auth_type eq '1'}">
                                    <div class="faq_bottom mt30 clear">
                                        <a href="#;" class="default_btn fr" id="insertFAQFormBtn"><i
                                                class="glyphicon glyphicon-plus"></i> 글쓰기</a>
                                    </div>
                                </c:if>
                            </div>
                        </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="clear">
                                        ...
                                        <a href="#;" class="default_btn fr" id="insertFAQCateFormBtn"><i
                                                class="glyphicon glyphicon-edit"></i> 카테고리 편집</a>
                                    </td>
                                </tr>
                                <tr>
                                    <th><span>질문</span></th>
                                    <td><input type="text" id="question" name="question" class="input"
                                               style="width:100%"></td>
                                </tr>
                                <tr>
                                    <th><span>답변</span></th>
                                    <td>
                                        <textarea id="answer" name="answer" style="width:100%" class="textarea"
                                                  rows="10"></textarea>
                                    </td>
                                </tr>
                            </tbody>
            ...
            <div class="lbody mt30">
                ...
                <div class="set_tbl mt10 clear">
                    <form id="faqCateForm" name="faqCateForm">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" id="faqCateName" name="faqCateName" class="input"
                                                   style="width:100%"></td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="fr">
                            <input type="submit" id="confirmFAQCateBtn" value="추가하기" class="submit"
