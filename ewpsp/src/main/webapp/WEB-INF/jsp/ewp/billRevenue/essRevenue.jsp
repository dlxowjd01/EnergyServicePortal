						...
						<div class="indiv">
							...
							<ul class="chart_total">
								<li class="ct1">
									...
									<div class="cval" id="essRevenueTot1"><span>14,976</span>won</div>
								</li>
								<li>
									<div class="ctit"><span>실적 할인금액</span></div>
									<div class="cval" id="essRevenueTot2"><span>20,976</span>won</div>
								</li>
							</ul>
						</div>
					</div>
...
// 								});
								...
								<div class="fold_div">
									...
									<div class="chart_table">			
										<table class="pc_use" id="pc_use_dataTable">
											...
											<tbody>
												<tr>
													<th><div class="ctit wht"><span>평일 일수 (d)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th><div class="ctit wht"><span>경부하충전량 (kWh)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th><div class="ctit wht"><span>중간부하충전량 (kWh)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th><div class="ctit wht"><span>최대부하충전량 (kWh)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th><div class="ctit wht"><span>경부하방전량 (kWh)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th><div class="ctit wht"><span>중간부하방전량 (kWh)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th><div class="ctit wht"><span>최대부하방전량 (kWh)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th><div class="ctit wht"><span>예상 할인금액 (won)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th><div class="ctit"><span>실적 할인금액 (won)</span></div></th>
													<td>1,000,000</td>
													<td>1,000,000</td>
													<td>1,000,000</td>
													<td>1,000,000</td>
												...
												<tr>
													<th><div class="ctit ct1"><span>고객 정산금액 (won)</span></div></th>
													<td>200,000</td>
													<td>200,000</td>
													<td>200,000</td>
													<td>200,000</td>
												...
												<tr>
													<th><div class="ctit wht"><span>EWP 정산금액 (won)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr>
													<th><div class="ctit wht"><span>정산비율 (%)</span></div></th>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
    ...
    <div id="layerbox" class="dprint" style="margin-top:300px;">
        <div class="ltit">      	
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="2" height="60" align="right" style="font-size:16px;font-weight:600;">
						이번 달 청구 금액은 <strong style="color:#438fd7">30,439,360</strong>원 입니다
