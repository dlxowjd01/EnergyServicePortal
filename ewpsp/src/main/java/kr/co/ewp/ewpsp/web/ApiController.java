...
import kr.co.ewp.ewpsp.common.util.*;
...
//			String siteId = device == null ? "" : device.get("site_id"); /*** 12.13 이우람 수정 ***/
    ...
    public @ResponseBody
    Map<String, Object> getSoc(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
        logger.debug("/getSoc");
...
//						}
    ...
    public @ResponseBody
    Map<String, Object> getPeak(@RequestParam HashMap param) throws Exception {
