...
//		model.addAttribute("deviceGbn", request.getParameter("deviceGbn"));
    ...
    public @ResponseBody
    Map<String, Object> getDeviceAlarmCnt(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getWarningAlarmList(@RequestParam HashMap param) throws Exception {
...
//		param.put("siteId", "17094385");
    ...
    public @ResponseBody
    Map<String, Object> getAlertAlarmList(@RequestParam HashMap param) throws Exception {
...
//		param.put("siteId", "17094385");
    ...
    public @ResponseBody
    Map<String, Object> updateAlarm(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getSmsAddresseeList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getInsertAddresseeNameList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> insertAddressee(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> deleteAddressee(@RequestParam HashMap param) throws Exception {
