...
public class CmpyGrpSiteMngServiceImpl implements CmpyGrpSiteMngService {
	...
	public List getGMainAreaSiteCntList(HashMap param) throws Exception {
		return cmpyGrpSiteMngDao.getGMainAreaSiteCntList(param);
	}
	...
	public List getGrpSiteList(Map<String, Object> param) throws Exception {
		return cmpyGrpSiteMngDao.getGrpSiteList(param);
	}
	
	public List getAllSiteList(Map<String, Object> param) throws Exception {
	...
	public int deleteSite(HashMap param) throws Exception {
		...
		if(deviceGrpList.size() > 0) {
			for (HashMap<String, Object> map : deviceGrpList) {
				...
				param2.put("modUid", param.get("modUid"));
				int cnt = deviceGroupDao.deleteDeviceGroup(param2);
