...
public class DRResultController {
    ...
    public @ResponseBody
    Map<String, Object> getDRResultList(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getCbl(@RequestParam HashMap param) throws Exception {
        logger.debug("/getCbl");
        logger.debug("param ::::: " + param.toString());
    ...
    public @ResponseBody
    Map<String, Object> searchDRApi(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
