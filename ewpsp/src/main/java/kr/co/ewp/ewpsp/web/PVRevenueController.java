...
public class PVRevenueController {
    ...
    public @ResponseBody
    Map<String, Object> getPVRevenueList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
...
//		resultMap.put("resultListMap", result);
    ...
    public @ResponseBody
    Map<String, Object> getPVRevenueTexList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
...
//		resultMap.put("resultListMap", result);
    ...
    public @ResponseBody
    Map<String, Object> getPVRevenueTex(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
