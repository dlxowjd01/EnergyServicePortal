...
public class ESSRevenueController {
    ...
    public @ResponseBody
    Map<String, Object> getESSRevenueList(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getESSRevenueTexList(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getESSRevenueTex(@RequestParam HashMap param) throws Exception {
