...
public class DERUsageController {
    ...
    public @ResponseBody
    Map<String, Object> getESSUsageList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getDERUsageList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
