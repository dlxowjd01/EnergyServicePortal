...
public class DRRevenueController {
    ...
    public @ResponseBody
    Map<String, Object> getDRRevenueList(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getDRRevenueTexList(@RequestParam HashMap param) throws Exception {
    ...
    @RequestMapping("/getDRRevenueTex")
    public @ResponseBody
    Map<String, Object> getDRRevenueTex(@RequestParam HashMap param) throws Exception {
        logger.debug("/getDRRevenueTex");
        logger.debug("param ::::: " + param.toString());
