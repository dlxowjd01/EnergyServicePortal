...
public class DeviceGroupController {
    ...
    public @ResponseBody
    Map<String, Object> getDeviceGroupList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getDvInDeviceGroupList(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getDeviceGrpAlarmList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getDvInDeviceGroupPopupList(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getDeviceNotInGroupList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> saveDvInDvGrp(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> saveDvGrp(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
        ...
        String nowDvGrpIds_arr[] = null; // 기존 그룹목록
        String newDvGrpIds_arr[] = null; // 변경할 그룹목록
        ...
        if ("Y".equals(changeYn)) {
            // 로직 : 기존장치그룹목록과 변경된장치그룹목록을 비교한다.
            // 기존에 존재하고 변경된 목록에 미존재 : 목록에서 제외됨
            // 기존에도 존재하고 변경된 목록에도 존재 : 변동없음
            int delCnt = 0;
            if (nowDvGrpIds_arr != null) {
                if (nowDvGrpIds_arr.length > 0) { // 기존장치그룹목록의 데이터가 변동된장치그룹목록에 존재하는지 확인
                    for (int i = 0; i < nowDvGrpIds_arr.length; i++) {
                        ...
                        if (!res) { // 기존장치그룹목록에 존재하고 변경된 장치그룹목록에 미존재 : 목록에서 제외됨
                            HashMap<String, Object> dvGrpMap = new HashMap<String, Object>();
                            dvGrpMap.put("deviceGrpIdx", str);
                            ...
                            if (delDvCnt == dvList.size()) {
                                ...
                                int cnt = deviceGroupService.deleteDeviceGroup(dvGrpMap);
                                delCnt = delCnt + cnt;
                            }
                        }
                    }
    ...
    public @ResponseBody
    Map<String, Object> insertDevice(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> deleteDevices(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getDeviceGrpSitePopupList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
