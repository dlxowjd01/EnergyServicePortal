...
public class SiteSet {
  ...
  private String chargeYearm;// 요금적용기준년월(형식:yyyymm)
  private Long chargePower;// 요금적용전력(단위:kw)
   ...
   * @return chargeYearm
   */
  public String getChargeYearm() {
    return this.chargeYearm;
  }
   ...
   * @return chargeYearm
   */
  public void setChargeYearm(String chargeYearm) {
    this.chargeYearm = chargeYearm;
  }
