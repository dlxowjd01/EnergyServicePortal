...
//	private ContextPropertiesUtil properties;
    ...
    public @ResponseBody
    Map<String, Object> getCmpyList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getGroupList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
...
//		param.put("siteId", request.getSession().getAttribute("selViewSiteId"));
    ...
    public @ResponseBody
    Map<String, Object> getSiteList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
...
//		param.put("siteId", request.getSession().getAttribute("selViewSiteId"));
    ...
    public @ResponseBody
    Map<String, Object> getCmpyPopupList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
...
//			param.put("siteGrpIdx", userInfo.get("site_grp_idx"));
    ...
    public @ResponseBody
    Map<String, Object> getGroupPopupList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getSitePopupList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
...
//			param.put("userIdx", userInfo.get("user_idx"));
    ...
    public @ResponseBody
    Map<String, Object> getCmpyDetail(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getGroupDetail(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getSiteDetail(@RequestParam HashMap param) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> saveSiteInSiteGrp(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> insertCmpy(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> insertGroup(@RequestParam HashMap param, MultipartHttpServletRequest multipart, HttpSession session) throws Exception {
...
//		HashMap<String, Object> m = CommonUtils.fileUpload(multipart, session);
    ...
    public @ResponseBody
    Map<String, Object> insertSite(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
...
//		Integer userIdx = (userInfo.get("user_idx") == null) ? null : (Integer) userInfo.get("user_idx");
    ...
    public @ResponseBody
    Map<String, Object> updateCmpy(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> updateGroup(@RequestParam HashMap param, MultipartHttpServletRequest multipart, HttpSession session) throws Exception {
...
//			HashMap<String, Object> m = CommonUtils.fileUpload(multipart, session);
    ...
    public @ResponseBody
    Map<String, Object> updateSite(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> deleteGroup(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
...
//		}
    ...
    public @ResponseBody
    Map<String, Object> deleteCmpy(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> deleteSite(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
