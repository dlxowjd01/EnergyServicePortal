...
public class ESSChargeController {
    ...
    public @ResponseBody
    Map<String, Object> getESSChargeRealList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
    ...
    public @ResponseBody
    Map<String, Object> getESSChargeFutureList(@RequestParam HashMap param, HttpServletRequest request) throws Exception {
