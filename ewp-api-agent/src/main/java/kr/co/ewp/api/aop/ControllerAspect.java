...
public class ControllerAspect {
  ...
  @Around("execution(* " + Constants.PACKAGE_BASE + ".controller..*.*(..)) ")
  public Object commonController(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    try {
      if (prettyLog != null) {
        prettyLog.start(String.format("%s,%s,%s", "CONTROLLER", joinPoint.getTarget().getClass().getSimpleName(), methodName));
